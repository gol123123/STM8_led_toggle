 ...
 568  004e               L41:
 569                     ; 90     assert_param(IS_ADC1_CHANNEL_OK(ADC1_Channel));
 ...
 615  00a1               L22:
 616                     ; 91     assert_param(IS_ADC1_PRESSEL_OK(ADC1_PrescalerSelection));
 ...
 653  00e2               L03:
 654                     ; 92     assert_param(IS_ADC1_EXTTRIG_OK(ADC1_ExtTrigger));
 ...
 673  00ff               L63:
 674                     ; 93     assert_param(IS_FUNCTIONALSTATE_OK(((ADC1_ExtTriggerState))));
 ...
 693  011c               L44:
 694                     ; 94     assert_param(IS_ADC1_ALIGN_OK(ADC1_Align));
 ...
 713  0139               L25:
 714                     ; 95     assert_param(IS_ADC1_SCHMITTTRIG_OK(ADC1_SchmittTriggerChannel));
 ...
 763  0192               L06:
 764                     ; 96     assert_param(IS_FUNCTIONALSTATE_OK(ADC1_SchmittTriggerState));
 ...
 783  01af               L66:
 784                     ; 101     ADC1_ConversionConfig(ADC1_ConversionMode, ADC1_Channel, ADC1_Align);
 ...
 867                     ; 130     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 869  01da 4d            	tnz	a
 ...
 885  01f4               L67:
 886                     ; 132     if (NewState != DISABLE)
 888  01f4 0d01          	tnz	(OFST+1,sp)
 889  01f6 2706          	jreq	L562
 890                     ; 134         ADC1->CR1 |= ADC1_CR1_ADON;
 892  01f8 72105401      	bset	21505,#0
 894  01fc 2004          	jra	L762
 895  01fe               L562:
 896                     ; 138         ADC1->CR1 &= (uint8_t)(~ADC1_CR1_ADON);
 898  01fe 72115401      	bres	21505,#0
 899  0202               L762:
 900                     ; 141 }
 903  0202 84            	pop	a
 904  0203 81            	ret
 940                     ; 148 void ADC1_ScanModeCmd(FunctionalState NewState)
 940                     ; 149 {
 941                     	switch	.text
 942  0204               _ADC1_ScanModeCmd:
 944  0204 88            	push	a
 945       00000000      OFST:	set	0
 948                     ; 152     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 950  0205 4d            	tnz	a
 ...
 966  021f               L601:
 967                     ; 154     if (NewState != DISABLE)
 969  021f 0d01          	tnz	(OFST+1,sp)
 970  0221 2706          	jreq	L703
 971                     ; 156         ADC1->CR2 |= ADC1_CR2_SCAN;
 973  0223 72125402      	bset	21506,#1
 975  0227 2004          	jra	L113
 976  0229               L703:
 977                     ; 160         ADC1->CR2 &= (uint8_t)(~ADC1_CR2_SCAN);
 979  0229 72135402      	bres	21506,#1
 980  022d               L113:
 981                     ; 163 }
 984  022d 84            	pop	a
 985  022e 81            	ret
1021                     ; 170 void ADC1_DataBufferCmd(FunctionalState NewState)
1021                     ; 171 {
1022                     	switch	.text
1023  022f               _ADC1_DataBufferCmd:
1025  022f 88            	push	a
1026       00000000      OFST:	set	0
1029                     ; 174     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1031  0230 4d            	tnz	a
...
1047  024a               L611:
1048                     ; 176     if (NewState != DISABLE)
1050  024a 0d01          	tnz	(OFST+1,sp)
1051  024c 2706          	jreq	L133
1052                     ; 178         ADC1->CR3 |= ADC1_CR3_DBUF;
1054  024e 721e5403      	bset	21507,#7
1056  0252 2004          	jra	L333
1057  0254               L133:
1058                     ; 182         ADC1->CR3 &= (uint8_t)(~ADC1_CR3_DBUF);
1060  0254 721f5403      	bres	21507,#7
1061  0258               L333:
1062                     ; 185 }
1065  0258 84            	pop	a
1066  0259 81            	ret
1223                     ; 196 void ADC1_ITConfig(ADC1_IT_TypeDef ADC1_IT, FunctionalState NewState)
1223                     ; 197 {
1224                     	switch	.text
1225  025a               _ADC1_ITConfig:
1227  025a 89            	pushw	x
1228       00000000      OFST:	set	0
1231                     ; 200     assert_param(IS_ADC1_IT_OK(ADC1_IT));
...
1249  0278               L621:
1250                     ; 201     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
1292  02ac 85            	popw	x
1293  02ad 81            	ret
1330                     ; 222 void ADC1_PrescalerConfig(ADC1_PresSel_TypeDef ADC1_Prescaler)
1330                     ; 223 {
1331                     	switch	.text
1332  02ae               _ADC1_PrescalerConfig:
1334  02ae 88            	push	a
1335       00000000      OFST:	set	0
1338                     ; 226     assert_param(IS_ADC1_PRESSEL_OK(ADC1_Prescaler));
1340  02af 4d            	tnz	a
...
1368  02e1               L441:
1369                     ; 229     ADC1->CR1 &= (uint8_t)(~ADC1_CR1_SPSEL);
1371  02e1 c65401        	ld	a,21505
1372  02e4 a48f          	and	a,#143
1373  02e6 c75401        	ld	21505,a
1374                     ; 231     ADC1->CR1 |= (uint8_t)(ADC1_Prescaler);
...
1382  02f1 84            	pop	a
1383  02f2 81            	ret
1431                     ; 244 void ADC1_SchmittTriggerConfig(ADC1_SchmittTrigg_TypeDef ADC1_SchmittTriggerChannel, FunctionalState NewState)
1431                     ; 245 {
1432                     	switch	.text
1433  02f3               _ADC1_SchmittTriggerConfig:
1435  02f3 89            	pushw	x
1436       00000000      OFST:	set	0
1439                     ; 248     assert_param(IS_ADC1_SCHMITTTRIG_OK(ADC1_SchmittTriggerChannel));
...
1489  0342               L451:
1490                     ; 249     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
1567  03a5               L774:
1568                     ; 272             ADC1->TDRL |= (uint8_t)((uint8_t)0x01 << (uint8_t)ADC1_SchmittTriggerChannel);
...
1584  03ba               L574:
1585                     ; 277         if (NewState != DISABLE)
1587  03ba 0d02          	tnz	(OFST+2,sp)
1588  03bc 2718          	jreq	L505
1589                     ; 279             ADC1->TDRH &= (uint8_t)(~(uint8_t)((uint8_t)0x01 << ((uint8_t)ADC1_SchmittTriggerChannel - (uint8_t)8)));
...
1608  03d6               L505:
1609                     ; 283             ADC1->TDRH |= (uint8_t)((uint8_t)0x01 << ((uint8_t)ADC1_SchmittTriggerChannel - (uint8_t)8));
...
1629  03eb 85            	popw	x
1630  03ec 81            	ret
1688                     ; 300 void ADC1_ConversionConfig(ADC1_ConvMode_TypeDef ADC1_ConversionMode, ADC1_Channel_TypeDef ADC1_Channel, ADC1_Align_TypeDef ADC1_Align)
1688                     ; 301 {
1689                     	switch	.text
1690  03ed               _ADC1_ConversionConfig:
1692  03ed 89            	pushw	x
1693       00000000      OFST:	set	0
1696                     ; 304     assert_param(IS_ADC1_CONVERSIONMODE_OK(ADC1_ConversionMode));
...
1716  040a               L212:
1717                     ; 305     assert_param(IS_ADC1_CHANNEL_OK(ADC1_Channel));
...
1763  045d               L022:
1764                     ; 306     assert_param(IS_ADC1_ALIGN_OK(ADC1_Align));
...
1820  04a6 85            	popw	x
1821  04a7 81            	ret
1868                     ; 342 void ADC1_ExternalTriggerConfig(ADC1_ExtTrig_TypeDef ADC1_ExtTrigger, FunctionalState NewState)
1868                     ; 343 {
1869                     	switch	.text
1870  04a8               _ADC1_ExternalTriggerConfig:
1872  04a8 89            	pushw	x
1873       00000000      OFST:	set	0
1876                     ; 346     assert_param(IS_ADC1_EXTTRIG_OK(ADC1_ExtTrigger));
...
1896  04c5               L632:
1897                     ; 347     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
1944  0500 85            	popw	x
1945  0501 81            	ret
1969                     ; 378 void ADC1_StartConversion(void)
1969                     ; 379 {
1970                     	switch	.text
1971  0502               _ADC1_StartConversion:
1975                     ; 380     ADC1->CR1 |= ADC1_CR1_ADON;
1977  0502 72105401      	bset	21505,#0
1978                     ; 381 }
1981  0506 81            	ret
2025                     ; 390 uint16_t ADC1_GetConversionValue(void)
2025                     ; 391 {
2026                     	switch	.text
2027  0507               _ADC1_GetConversionValue:
2029  0507 5205          	subw	sp,#5
2030       00000005      OFST:	set	5
2033                     ; 393     uint16_t temph = 0;
2035                     ; 394     uint8_t templ = 0;
2037                     ; 396     if ((ADC1->CR2 & ADC1_CR2_ALIGN) != 0) /* Right alignment */
2039  0509 c65402        	ld	a,21506
2040  050c a508          	bcp	a,#8
2041  050e 2715          	jreq	L326
2042                     ; 399         templ = ADC1->DRL;
...
2054                     ; 403         temph = (uint16_t)(templ | (uint16_t)(temph << (uint8_t)8));
...
2094  0546               L526:
2095                     ; 415     return ((uint16_t)temph);
2097  0546 1e04          	ldw	x,(OFST-1,sp)
2100  0548 5b05          	addw	sp,#5
2101  054a 81            	ret
2148                     ; 427 void ADC1_AWDChannelConfig(ADC1_Channel_TypeDef Channel, FunctionalState NewState)
2148                     ; 428 {
2149                     	switch	.text
2150  054b               _ADC1_AWDChannelConfig:
2152  054b 89            	pushw	x
2153       00000000      OFST:	set	0
2156                     ; 430     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
2176  0568               L062:
2177                     ; 431     assert_param(IS_ADC1_CHANNEL_OK(Channel));
...
2250  05da               L356:
2251                     ; 441             ADC1->AWCRL &= (uint8_t)~(uint8_t)((uint8_t)1 << Channel);
...
2268  05f0               L156:
2269                     ; 446         if (NewState != DISABLE)
2271  05f0 0d02          	tnz	(OFST+2,sp)
2272  05f2 2717          	jreq	L166
2273                     ; 448             ADC1->AWCRH |= (uint8_t)((uint8_t)1 << (Channel - (uint8_t)8));
...
2291  060b               L166:
2292                     ; 452             ADC1->AWCRH &= (uint8_t)~(uint8_t)((uint8_t)1 << (uint8_t)(Channel - (uint8_t)8));
...
2313  0621 85            	popw	x
2314  0622 81            	ret
2349                     ; 463 void ADC1_SetHighThreshold(uint16_t Threshold)
2349                     ; 464 {
2350                     	switch	.text
2351  0623               _ADC1_SetHighThreshold:
2353  0623 89            	pushw	x
2354       00000000      OFST:	set	0
2357                     ; 465     ADC1->HTRH = (uint8_t)(Threshold >> (uint8_t)2);
2359  0624 54            	srlw	x
2360  0625 54            	srlw	x
2361  0626 9f            	ld	a,xl
2362  0627 c75408        	ld	21512,a
2363                     ; 466     ADC1->HTRL = (uint8_t)Threshold;
2365  062a 7b02          	ld	a,(OFST+2,sp)
2366  062c c75409        	ld	21513,a
2367                     ; 467 }
2370  062f 85            	popw	x
2371  0630 81            	ret
2406                     ; 475 void ADC1_SetLowThreshold(uint16_t Threshold)
2406                     ; 476 {
2407                     	switch	.text
2408  0631               _ADC1_SetLowThreshold:
2412                     ; 477     ADC1->LTRL = (uint8_t)Threshold;
2414  0631 9f            	ld	a,xl
2415  0632 c7540b        	ld	21515,a
2416                     ; 478     ADC1->LTRH = (uint8_t)(Threshold >> (uint8_t)2);
2418  0635 54            	srlw	x
2419  0636 54            	srlw	x
...
2422                     ; 479 }
2425  063b 81            	ret
2479                     ; 488 uint16_t ADC1_GetBufferValue(uint8_t Buffer)
2479                     ; 489 {
2480                     	switch	.text
...
2488                     ; 491     uint16_t temph = 0;
2490                     ; 492     uint8_t templ = 0;
2492                     ; 495     assert_param(IS_ADC1_BUFFER_OK(Buffer));
2494  063f a10a          	cp	a,#10
2495  0641 2403          	jruge	L613
2496  0643 4f            	clr	a
2497  0644 2010          	jra	L023
2498  0646               L613:
2499  0646 ae01ef        	ldw	x,#495
...
2507  0656               L023:
2508                     ; 497     if ((ADC1->CR2 & ADC1_CR2_ALIGN) != 0) /* Right alignment */
2510  0656 c65402        	ld	a,21506
2511  0659 a508          	bcp	a,#8
2512  065b 271f          	jreq	L747
2513                     ; 500         templ = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1) + 1);
...
2522                     ; 502         temph = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1));
...
2533                     ; 504         temph = (uint16_t)(templ | (uint16_t)(temph << (uint8_t)8));
...
2542  067c               L747:
2543                     ; 509         temph = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1));
...
2554                     ; 511         templ = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1) + 1);
...
2563                     ; 513         temph = (uint16_t)((uint16_t)((uint16_t)templ << 6) | (uint16_t)(temph << 8));
...
2581  06a7               L157:
2582                     ; 516     return ((uint16_t)temph);
2584  06a7 1e04          	ldw	x,(OFST-1,sp)
2587  06a9 5b06          	addw	sp,#6
2588  06ab 81            	ret
2655                     ; 526 FlagStatus ADC1_GetAWDChannelStatus(ADC1_Channel_TypeDef Channel)
2655                     ; 527 {
2656                     	switch	.text
...
2664                     ; 528     uint8_t status = 0;
2666                     ; 531     assert_param(IS_ADC1_CHANNEL_OK(Channel));
2668  06ae 4d            	tnz	a
...
2702  06ec               L033:
2703                     ; 533     if (Channel < (uint8_t)8)
2705  06ec 7b02          	ld	a,(OFST+1,sp)
2706  06ee a108          	cp	a,#8
2707  06f0 2414          	jruge	L5001
2708                     ; 535         status = (uint8_t)(ADC1->AWSRL & (uint8_t)((uint8_t)1 << Channel));
...
2726  0706               L5001:
2727                     ; 539         status = (uint8_t)(ADC1->AWSRH & (uint8_t)((uint8_t)1 << (Channel - (uint8_t)8)));
...
2744  071a               L7001:
2745                     ; 542     return ((FlagStatus)status);
2747  071a 7b01          	ld	a,(OFST+0,sp)
2750  071c 85            	popw	x
2751  071d 81            	ret
2910                     ; 551 FlagStatus ADC1_GetFlagStatus(ADC1_Flag_TypeDef Flag)
2910                     ; 552 {
2911                     	switch	.text
...
2919                     ; 553     uint8_t flagstatus = 0;
2921                     ; 554     uint8_t temp = 0;
2923                     ; 557     assert_param(IS_ADC1_FLAG_OK(Flag));
...
2996                     ; 570             flagstatus = (uint8_t)(ADC1->AWSRL & (uint8_t)((uint8_t)1 << temp));
...
3014  07a0               L5011:
3015                     ; 574             flagstatus = (uint8_t)(ADC1->AWSRH & (uint8_t)((uint8_t)1 << (temp - 8)));
...
3033  07b6               L3011:
3034                     ; 579         flagstatus = (uint8_t)(ADC1->CSR & Flag);
3036  07b6 c65400        	ld	a,21504
3037  07b9 1402          	and	a,(OFST+1,sp)
3038  07bb 6b01          	ld	(OFST+0,sp),a
3040  07bd               L1011:
3041                     ; 581     return ((FlagStatus)flagstatus);
3043  07bd 7b01          	ld	a,(OFST+0,sp)
3046  07bf 85            	popw	x
3047  07c0 81            	ret
3092                     ; 591 void ADC1_ClearFlag(ADC1_Flag_TypeDef Flag)
3092                     ; 592 {
3093                     	switch	.text
...
3101                     ; 593     uint8_t temp = 0;
3103                     ; 596     assert_param(IS_ADC1_FLAG_OK(Flag));
...
3173                     ; 609             ADC1->AWSRL &= (uint8_t)~(uint8_t)((uint8_t)1 << temp);
...
3191  0842               L3411:
3192                     ; 613             ADC1->AWSRH &= (uint8_t)~(uint8_t)((uint8_t)1 << (temp - 8));
...
3210  085a               L1411:
3211                     ; 618         ADC1->CSR &= (uint8_t) (~Flag);
...
3221  0863 85            	popw	x
3222  0864 81            	ret
3278                     ; 640 ITStatus ADC1_GetITStatus(ADC1_IT_TypeDef ITPendingBit)
3278                     ; 641 {
3279                     	switch	.text
...
3287                     ; 642     ITStatus itstatus = RESET;
3289                     ; 643     uint8_t temp = 0;
3291                     ; 646     assert_param(IS_ADC1_ITPENDINGBIT_OK(ITPendingBit));
...
3331  08bb               L014:
3332                     ; 648     if (((uint16_t)ITPendingBit & 0xF0) == 0x10)
...
3342                     ; 651         temp = (uint8_t)((uint16_t)ITPendingBit & 0x0F);
...
3353                     ; 654             itstatus = (ITStatus)(ADC1->AWSRL & (uint8_t)((uint8_t)1 << temp));
...
3371  08e9               L1021:
3372                     ; 658             itstatus = (ITStatus)(ADC1->AWSRH & (uint8_t)((uint8_t)1 << (temp - 8)));
...
3390  08ff               L7711:
3391                     ; 663         itstatus = (ITStatus)(ADC1->CSR & (uint8_t)ITPendingBit);
3393  08ff c65400        	ld	a,21504
3394  0902 1403          	and	a,(OFST+2,sp)
3395  0904 6b01          	ld	(OFST+0,sp),a
3397  0906               L5021:
3398                     ; 665     return ((ITStatus)itstatus);
3400  0906 7b01          	ld	a,(OFST+0,sp)
3403  0908 5b03          	addw	sp,#3
3404  090a 81            	ret
3450                     ; 687 void ADC1_ClearITPendingBit(ADC1_IT_TypeDef ITPendingBit)
3450                     ; 688 {
3451                     	switch	.text
...
3459                     ; 689     uint8_t temp = 0;
3461                     ; 692     assert_param(IS_ADC1_ITPENDINGBIT_OK(ITPendingBit));
...
3501  0961               L034:
3502                     ; 694     if (((uint16_t)ITPendingBit & 0xF0) == 0x10)
...
3512                     ; 697         temp = (uint8_t)((uint16_t)ITPendingBit & 0x0F);
...
3523                     ; 700             ADC1->AWSRL &= (uint8_t)~(uint8_t)((uint8_t)1 << temp);
...
3541  0991               L3321:
3542                     ; 704             ADC1->AWSRH &= (uint8_t)~(uint8_t)((uint8_t)1 << (temp - 8));
...
3560  09a9               L1321:
3561                     ; 709         ADC1->CSR &= (uint8_t)((uint16_t)~(uint16_t)ITPendingBit);
...
3608  0000               L542:
3609  0000 7374645f6c69  	dc.b	"std_lib\src\stm8s_"
3610  0012 616463312e63  	dc.b	"adc1.c",0
3630                     	end
