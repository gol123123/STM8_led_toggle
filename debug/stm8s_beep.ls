  ...
  42                     ; 48 void BEEP_DeInit(void)
  42                     ; 49 {
  44                     	switch	.text
  45  0000               _BEEP_DeInit:
  49                     ; 50     BEEP->CSR = BEEP_CSR_RESET_VALUE;
  51  0000 351f50f3      	mov	20723,#31
  52                     ; 51 }
  55  0004 81            	ret
 121                     ; 61 void BEEP_Init(BEEP_Frequency_TypeDef BEEP_Frequency)
 121                     ; 62 {
 122                     	switch	.text
 123  0005               _BEEP_Init:
 125  0005 88            	push	a
 126       00000000      OFST:	set	0
 129                     ; 65     assert_param(IS_BEEP_FREQUENCY_OK(BEEP_Frequency));
 131  0006 4d            	tnz	a
 ...
 251  0058               L301:
 252                     ; 97         BEEP->CSR &= (uint8_t)(~BEEP_CSR_BEEPEN);
 ...
 320                     ; 114 void BEEP_LSICalibrationConfig(uint32_t LSIFreqHz)
 320                     ; 115 {
 321                     	switch	.text
 322  005d               _BEEP_LSICalibrationConfig:
 324  005d 5206          	subw	sp,#6
 325       00000006      OFST:	set	6
 328                     ; 121     assert_param(IS_LSI_FREQUENCY_OK(LSIFreqHz));
 ...
 443                     	switch	.const
 444  000c               L15:
 445  000c 7374645f6c69  	dc.b	"std_lib\src\stm8s_"
 446  001e 626565702e63  	dc.b	"beep.c",0
 447                     	xref.b	c_lreg
 448                     	xref.b	c_x
 468                     	xref	c_imul
 469                     	xref	c_ludv
