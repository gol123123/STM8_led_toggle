 ...
 481  0152               L531:
 482                     ; 135       result = (uint16_t) ((InputClockFrequencyMHz * 1000000) / (OutputClockFrequencyHz * 25));
 ...
 540                     ; 151     I2C->TRISER = (uint8_t)tmpval;
 542  019d 7b06          	ld	a,(OFST-3,sp)
 543  019f c7521d        	ld	21021,a
 545  01a2 2043          	jra	L341
 546  01a4               L331:
 547                     ; 158     result = (uint16_t)((InputClockFrequencyMHz * 1000000) / (OutputClockFrequencyHz << (uint8_t)1));
 ...
 636  021a 81            	ret
 692                     ; 196 void I2C_Cmd(FunctionalState NewState)
 692                     ; 197 {
 693                     	switch	.text
 694  021b               _I2C_Cmd:
 696  021b 88            	push	a
 697       00000000      OFST:	set	0
 700                     ; 200   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 702  021c 4d            	tnz	a
 ...
 718  0236               L46:
 719                     ; 202   if (NewState != DISABLE)
 721  0236 0d01          	tnz	(OFST+1,sp)
 722  0238 2706          	jreq	L571
 723                     ; 205     I2C->CR1 |= I2C_CR1_PE;
 725  023a 72105210      	bset	21008,#0
 727  023e 2004          	jra	L771
 728  0240               L571:
 729                     ; 210     I2C->CR1 &= (uint8_t)(~I2C_CR1_PE);
 731  0240 72115210      	bres	21008,#0
 732  0244               L771:
 733                     ; 212 }
 736  0244 84            	pop	a
 737  0245 81            	ret
 773                     ; 220 void I2C_GeneralCallCmd(FunctionalState NewState)
 773                     ; 221 {
 774                     	switch	.text
 775  0246               _I2C_GeneralCallCmd:
 777  0246 88            	push	a
 778       00000000      OFST:	set	0
 781                     ; 224   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 783  0247 4d            	tnz	a
 ...
 799  0261               L47:
 800                     ; 226   if (NewState != DISABLE)
 802  0261 0d01          	tnz	(OFST+1,sp)
 803  0263 2706          	jreq	L712
 804                     ; 229     I2C->CR1 |= I2C_CR1_ENGC;
 806  0265 721c5210      	bset	21008,#6
 808  0269 2004          	jra	L122
 809  026b               L712:
 810                     ; 234     I2C->CR1 &= (uint8_t)(~I2C_CR1_ENGC);
 812  026b 721d5210      	bres	21008,#6
 813  026f               L122:
 814                     ; 236 }
 817  026f 84            	pop	a
 818  0270 81            	ret
 854                     ; 246 void I2C_GenerateSTART(FunctionalState NewState)
 854                     ; 247 {
 855                     	switch	.text
 856  0271               _I2C_GenerateSTART:
 858  0271 88            	push	a
 859       00000000      OFST:	set	0
 862                     ; 250   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 864  0272 4d            	tnz	a
 ...
 880  028c               L401:
 881                     ; 252   if (NewState != DISABLE)
 883  028c 0d01          	tnz	(OFST+1,sp)
 884  028e 2706          	jreq	L142
 885                     ; 255     I2C->CR2 |= I2C_CR2_START;
 887  0290 72105211      	bset	21009,#0
 889  0294 2004          	jra	L342
 890  0296               L142:
 891                     ; 260     I2C->CR2 &= (uint8_t)(~I2C_CR2_START);
 893  0296 72115211      	bres	21009,#0
 894  029a               L342:
 895                     ; 262 }
 898  029a 84            	pop	a
 899  029b 81            	ret
 935                     ; 270 void I2C_GenerateSTOP(FunctionalState NewState)
 935                     ; 271 {
 936                     	switch	.text
 937  029c               _I2C_GenerateSTOP:
 939  029c 88            	push	a
 940       00000000      OFST:	set	0
 943                     ; 274   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 945  029d 4d            	tnz	a
 ...
 961  02b7               L411:
 962                     ; 276   if (NewState != DISABLE)
 964  02b7 0d01          	tnz	(OFST+1,sp)
 965  02b9 2706          	jreq	L362
 966                     ; 279     I2C->CR2 |= I2C_CR2_STOP;
 968  02bb 72125211      	bset	21009,#1
 970  02bf 2004          	jra	L562
 971  02c1               L362:
 972                     ; 284     I2C->CR2 &= (uint8_t)(~I2C_CR2_STOP);
 974  02c1 72135211      	bres	21009,#1
 975  02c5               L562:
 976                     ; 286 }
 979  02c5 84            	pop	a
 980  02c6 81            	ret
1017                     ; 294 void I2C_SoftwareResetCmd(FunctionalState NewState)
1017                     ; 295 {
1018                     	switch	.text
1019  02c7               _I2C_SoftwareResetCmd:
1021  02c7 88            	push	a
1022       00000000      OFST:	set	0
1025                     ; 297   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1027  02c8 4d            	tnz	a
...
1043  02e2               L421:
1044                     ; 299   if (NewState != DISABLE)
1046  02e2 0d01          	tnz	(OFST+1,sp)
1047  02e4 2706          	jreq	L503
1048                     ; 302     I2C->CR2 |= I2C_CR2_SWRST;
1050  02e6 721e5211      	bset	21009,#7
1052  02ea 2004          	jra	L703
1053  02ec               L503:
1054                     ; 307     I2C->CR2 &= (uint8_t)(~I2C_CR2_SWRST);
1056  02ec 721f5211      	bres	21009,#7
1057  02f0               L703:
1058                     ; 309 }
1061  02f0 84            	pop	a
1062  02f1 81            	ret
1099                     ; 318 void I2C_StretchClockCmd(FunctionalState NewState)
1099                     ; 319 {
1100                     	switch	.text
1101  02f2               _I2C_StretchClockCmd:
1103  02f2 88            	push	a
1104       00000000      OFST:	set	0
1107                     ; 321   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1109  02f3 4d            	tnz	a
...
1125  030d               L431:
1126                     ; 323   if (NewState != DISABLE)
1128  030d 0d01          	tnz	(OFST+1,sp)
1129  030f 2706          	jreq	L723
1130                     ; 326     I2C->CR1 &= (uint8_t)(~I2C_CR1_NOSTRETCH);
1132  0311 721f5210      	bres	21008,#7
1134  0315 2004          	jra	L133
1135  0317               L723:
1136                     ; 332     I2C->CR1 |= I2C_CR1_NOSTRETCH;
1138  0317 721e5210      	bset	21008,#7
1139  031b               L133:
1140                     ; 334 }
1143  031b 84            	pop	a
1144  031c 81            	ret
1181                     ; 343 void I2C_AcknowledgeConfig(I2C_Ack_TypeDef Ack)
1181                     ; 344 {
1182                     	switch	.text
1183  031d               _I2C_AcknowledgeConfig:
1185  031d 88            	push	a
1186       00000000      OFST:	set	0
1189                     ; 347   assert_param(IS_I2C_ACK_OK(Ack));
1191  031e 4d            	tnz	a
...
1447                     ; 409   assert_param(IS_I2C_DUTYCYCLE_OK(I2C_DutyCycle));
1449  03ca 4d            	tnz	a
...
1465  03e4               L271:
1466                     ; 411   if (I2C_DutyCycle == I2C_DUTYCYCLE_16_9)
1468  03e4 7b01          	ld	a,(OFST+1,sp)
1469  03e6 a140          	cp	a,#64
1470  03e8 2606          	jrne	L734
1471                     ; 414     I2C->CCRH |= I2C_CCRH_DUTY;
1473  03ea 721c521c      	bset	21020,#6
1475  03ee 2004          	jra	L144
1476  03f0               L734:
1477                     ; 419     I2C->CCRH &= (uint8_t)(~I2C_CCRH_DUTY);
1479  03f0 721d521c      	bres	21020,#6
1480  03f4               L144:
1481                     ; 421 }
1484  03f4 84            	pop	a
1485  03f5 81            	ret
1508                     ; 428 uint8_t I2C_ReceiveData(void)
1508                     ; 429 {
1509                     	switch	.text
1510  03f6               _I2C_ReceiveData:
1514                     ; 431   return ((uint8_t)I2C->DR);
1516  03f6 c65216        	ld	a,21014
1519  03f9 81            	ret
1585                     ; 441 void I2C_Send7bitAddress(uint8_t Address, I2C_Direction_TypeDef Direction)
1585                     ; 442 {
1586                     	switch	.text
1587  03fa               _I2C_Send7bitAddress:
1589  03fa 89            	pushw	x
1590       00000000      OFST:	set	0
1593                     ; 444   assert_param(IS_I2C_ADDRESS_OK(Address));
...
1609  0413               L202:
1610                     ; 445   assert_param(IS_I2C_DIRECTION_OK(Direction));
...
1643  043d 85            	popw	x
1644  043e 81            	ret
1678                     ; 459 void I2C_SendData(uint8_t Data)
1678                     ; 460 {
1679                     	switch	.text
1680  043f               _I2C_SendData:
1684                     ; 462   I2C->DR = Data;
1686  043f c75216        	ld	21014,a
1687                     ; 463 }
1690  0442 81            	ret
1915                     ; 579 ErrorStatus I2C_CheckEvent(I2C_Event_TypeDef I2C_Event)
1915                     ; 580 {
1916                     	switch	.text
...
1924                     ; 581   __IO uint16_t lastevent = 0x00;
1926  0446 5f            	clrw	x
1927  0447 1f04          	ldw	(OFST-2,sp),x
1929                     ; 582   uint8_t flag1 = 0x00 ;
1931                     ; 583   uint8_t flag2 = 0x00;
1933                     ; 584   ErrorStatus status = ERROR;
1935                     ; 587   assert_param(IS_I2C_EVENT_OK(I2C_Event));
...
1997  04cc               L222:
1998                     ; 589   if (I2C_Event == I2C_EVENT_SLAVE_ACK_FAILURE)
2000  04cc 1e07          	ldw	x,(OFST+1,sp)
2001  04ce a30004        	cpw	x,#4
2002  04d1 260b          	jrne	L336
2003                     ; 591     lastevent = I2C->SR2 & I2C_SR2_AF;
...
2013  04de               L336:
2014                     ; 595     flag1 = I2C->SR1;
2016  04de c65217        	ld	a,21015
2017  04e1 6b03          	ld	(OFST-3,sp),a
2019                     ; 596     flag2 = I2C->SR3;
2021  04e3 c65219        	ld	a,21017
2022  04e6 6b06          	ld	(OFST+0,sp),a
2024                     ; 597     lastevent = ((uint16_t)((uint16_t)flag2 << (uint16_t)8) | (uint16_t)flag1);
...
2043  04fd               L536:
2044                     ; 600   if (((uint16_t)lastevent & (uint16_t)I2C_Event) == (uint16_t)I2C_Event)
...
2182  0545               L376:
2183                     ; 649   return (I2C_Event_TypeDef)lastevent;
2185  0545 1e05          	ldw	x,(OFST-1,sp)
2188  0547 5b06          	addw	sp,#6
2189  0549 81            	ret
2405                     ; 680 FlagStatus I2C_GetFlagStatus(I2C_Flag_TypeDef I2C_Flag)
2405                     ; 681 {
2406                     	switch	.text
...
2414                     ; 682   uint8_t tempreg = 0;
2416  054c 0f02          	clr	(OFST+0,sp)
2418                     ; 683   uint8_t regindex = 0;
2420                     ; 684   FlagStatus bitstatus = RESET;
2422                     ; 687   assert_param(IS_I2C_FLAG_OK(I2C_Flag));
...
2468  05b1               L432:
2469                     ; 690   regindex = (uint8_t)((uint16_t)I2C_Flag >> 8);
2471  05b1 7b03          	ld	a,(OFST+1,sp)
2472  05b3 6b01          	ld	(OFST-1,sp),a
2474                     ; 692   switch (regindex)
...
2486  05c2               L576:
2487                     ; 695     case 0x01:
2487                     ; 696       tempreg = (uint8_t)I2C->SR1;
...
2495  05c9               L776:
2496                     ; 700     case 0x02:
2496                     ; 701       tempreg = (uint8_t)I2C->SR2;
...
2504  05d0               L107:
2505                     ; 705     case 0x03:
2505                     ; 706       tempreg = (uint8_t)I2C->SR3;
...
2594                     ; 762   uint16_t flagpos = 0;
2596                     ; 764   assert_param(IS_I2C_CLEAR_FLAG_OK(I2C_FLAG));
...
2619  060b               L242:
2620                     ; 767   flagpos = (uint16_t)I2C_FLAG & FLAG_Mask;
...
2631                     ; 769   I2C->SR2 = (uint8_t)((uint16_t)(~flagpos));
...
2640  061f 81            	ret
2807                     ; 792 ITStatus I2C_GetITStatus(I2C_ITPendingBit_TypeDef I2C_ITPendingBit)
2807                     ; 793 {
2808                     	switch	.text
...
2816                     ; 794   ITStatus bitstatus = RESET;
2818                     ; 795   __IO uint8_t enablestatus = 0;
2820  0623 0f03          	clr	(OFST-1,sp)
2822                     ; 796   uint16_t tempregister = 0;
2824                     ; 799     assert_param(IS_I2C_ITPENDINGBIT_OK(I2C_ITPendingBit));
...
2862  0674               L252:
2863                     ; 801   tempregister = (uint8_t)( ((uint16_t)((uint16_t)I2C_ITPendingBit & ITEN_Mask)) >> 8);
2865  0674 7b05          	ld	a,(OFST+1,sp)
2866  0676 a407          	and	a,#7
2867  0678 5f            	clrw	x
2868  0679 97            	ld	xl,a
2869  067a 1f01          	ldw	(OFST-3,sp),x
2871                     ; 804   enablestatus = (uint8_t)(I2C->ITR & ( uint8_t)tempregister);
2873  067c c6521a        	ld	a,21018
2874  067f 1402          	and	a,(OFST-2,sp)
2875  0681 6b03          	ld	(OFST-1,sp),a
2877                     ; 806   if ((uint16_t)((uint16_t)I2C_ITPendingBit & REGISTER_Mask) == REGISTER_SR1_Index)
...
2889                     ; 809     if (((I2C->SR1 & (uint8_t)I2C_ITPendingBit) != RESET) && enablestatus)
...
2993                     ; 875   uint16_t flagpos = 0;
2995                     ; 878   assert_param(IS_I2C_CLEAR_ITPENDINGBIT_OK(I2C_ITPendingBit));
...
3019  06ee               L262:
3020                     ; 881   flagpos = (uint16_t)I2C_ITPendingBit & FLAG_Mask;
...
3031                     ; 884   I2C->SR2 = (uint8_t)((uint16_t)~flagpos);
...
3074                     	switch	.const
3075  000c               L131:
3076  000c 7374645f6c69  	dc.b	"std_lib\src\stm8s_"
3077  001e 6932632e6300  	dc.b	"i2c.c",0
3078                     	xref.b	c_lreg
3079                     	xref.b	c_x
3099                     	xref	c_sdivx
3100                     	xref	c_ludv
