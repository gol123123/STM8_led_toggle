 ...
 312  00c9               L41:
 313                     ; 115     TIM1->ARRH = (uint8_t)(TIM1_Period >> 8);
 315  00c9 7b06          	ld	a,(OFST+6,sp)
 316  00cb c75262        	ld	21090,a
 317                     ; 116     TIM1->ARRL = (uint8_t)(TIM1_Period);
 319  00ce 7b07          	ld	a,(OFST+7,sp)
 320  00d0 c75263        	ld	21091,a
 321                     ; 119     TIM1->PSCRH = (uint8_t)(TIM1_Prescaler >> 8);
 323  00d3 7b01          	ld	a,(OFST+1,sp)
 324  00d5 c75260        	ld	21088,a
 325                     ; 120     TIM1->PSCRL = (uint8_t)(TIM1_Prescaler);
 327  00d8 7b02          	ld	a,(OFST+2,sp)
 328  00da c75261        	ld	21089,a
 329                     ; 123     TIM1->CR1 = (uint8_t)((uint8_t)(TIM1->CR1 & (uint8_t)(~(TIM1_CR1_CMS | TIM1_CR1_DIR)))
 329                     ; 124                            | (uint8_t)(TIM1_CounterMode));
 331  00dd c65250        	ld	a,21072
 332  00e0 a48f          	and	a,#143
 333  00e2 1a05          	or	a,(OFST+5,sp)
 334  00e4 c75250        	ld	21072,a
 335                     ; 127     TIM1->RCR = TIM1_RepetitionCounter;
 337  00e7 7b08          	ld	a,(OFST+8,sp)
 338  00e9 c75264        	ld	21092,a
 339                     ; 129 }
 342  00ec 85            	popw	x
 343  00ed 81            	ret
 629                     ; 150 void TIM1_OC1Init(TIM1_OCMode_TypeDef TIM1_OCMode,
 629                     ; 151                   TIM1_OutputState_TypeDef TIM1_OutputState,
 629                     ; 152                   TIM1_OutputNState_TypeDef TIM1_OutputNState,
 629                     ; 153                   uint16_t TIM1_Pulse,
 629                     ; 154                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
 629                     ; 155                   TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity,
 629                     ; 156                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState,
 629                     ; 157                   TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
 629                     ; 158 {
 630                     	switch	.text
 ...
 638                     ; 160     assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
 640  00f1 9e            	ld	a,xh
 641  00f2 4d            	tnz	a
 ...
 670  0121               L42:
 671                     ; 161     assert_param(IS_TIM1_OUTPUT_STATE_OK(TIM1_OutputState));
 ...
 690  013e               L23:
 691                     ; 162     assert_param(IS_TIM1_OUTPUTN_STATE_OK(TIM1_OutputNState));
 ...
 710  015b               L04:
 711                     ; 163     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
 ...
 730  0178               L64:
 731                     ; 164     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
 ...
 750  0195               L45:
 751                     ; 165     assert_param(IS_TIM1_OCIDLE_STATE_OK(TIM1_OCIdleState));
 ...
 770  01b2               L26:
 771                     ; 166     assert_param(IS_TIM1_OCNIDLE_STATE_OK(TIM1_OCNIdleState));
 ...
 790  01cf               L07:
 791                     ; 170     TIM1->CCER1 &= (uint8_t)(~( TIM1_CCER1_CC1E | TIM1_CCER1_CC1NE 
 791                     ; 171                                | TIM1_CCER1_CC1P | TIM1_CCER1_CC1NP));
 793  01cf c6525c        	ld	a,21084
 794  01d2 a4f0          	and	a,#240
 795  01d4 c7525c        	ld	21084,a
 796                     ; 174   TIM1->CCER1 |= (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER1_CC1E)
 796                     ; 175                                      | (uint8_t)(TIM1_OutputNState & TIM1_CCER1_CC1NE))
 796                     ; 176                            | (uint8_t)( (uint8_t)(TIM1_OCPolarity  & TIM1_CCER1_CC1P)
 796                     ; 177                                         | (uint8_t)(TIM1_OCNPolarity & TIM1_CCER1_CC1NP)));
 ...
 817                     ; 180     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM)) | 
 817                     ; 181                             (uint8_t)TIM1_OCMode);
 819  01f9 c65258        	ld	a,21080
 820  01fc a48f          	and	a,#143
 821  01fe 1a04          	or	a,(OFST+1,sp)
 822  0200 c75258        	ld	21080,a
 823                     ; 184     TIM1->OISR &= (uint8_t)(~(TIM1_OISR_OIS1 | TIM1_OISR_OIS1N));
 825  0203 c6526f        	ld	a,21103
 826  0206 a4fc          	and	a,#252
 827  0208 c7526f        	ld	21103,a
 828                     ; 186     TIM1->OISR |= (uint8_t)((uint8_t)( TIM1_OCIdleState & TIM1_OISR_OIS1 ) | 
 828                     ; 187                             (uint8_t)( TIM1_OCNIdleState & TIM1_OISR_OIS1N ));
 ...
 839                     ; 190     TIM1->CCR1H = (uint8_t)(TIM1_Pulse >> 8);
 841  021d 7b09          	ld	a,(OFST+6,sp)
 842  021f c75265        	ld	21093,a
 843                     ; 191     TIM1->CCR1L = (uint8_t)(TIM1_Pulse);
 845  0222 7b0a          	ld	a,(OFST+7,sp)
 846  0224 c75266        	ld	21094,a
 847                     ; 192 }
 850  0227 5b05          	addw	sp,#5
 851  0229 81            	ret
 956                     ; 213 void TIM1_OC2Init(TIM1_OCMode_TypeDef TIM1_OCMode,
 956                     ; 214                   TIM1_OutputState_TypeDef TIM1_OutputState,
 956                     ; 215                   TIM1_OutputNState_TypeDef TIM1_OutputNState,
 956                     ; 216                   uint16_t TIM1_Pulse,
 956                     ; 217                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
 956                     ; 218                   TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity,
 956                     ; 219                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState,
 956                     ; 220                   TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
 956                     ; 221 {
 957                     	switch	.text
 ...
 965                     ; 223     assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
 967  022d 9e            	ld	a,xh
 968  022e 4d            	tnz	a
 ...
 997  025d               L001:
 998                     ; 224     assert_param(IS_TIM1_OUTPUT_STATE_OK(TIM1_OutputState));
...
1017  027a               L601:
1018                     ; 225     assert_param(IS_TIM1_OUTPUTN_STATE_OK(TIM1_OutputNState));
...
1037  0297               L411:
1038                     ; 226     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
...
1057  02b4               L221:
1058                     ; 227     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
...
1077  02d1               L031:
1078                     ; 228     assert_param(IS_TIM1_OCIDLE_STATE_OK(TIM1_OCIdleState));
...
1097  02ee               L631:
1098                     ; 229     assert_param(IS_TIM1_OCNIDLE_STATE_OK(TIM1_OCNIdleState));
...
1117  030b               L441:
1118                     ; 233     TIM1->CCER1 &= (uint8_t)(~( TIM1_CCER1_CC2E | TIM1_CCER1_CC2NE | 
1118                     ; 234                                 TIM1_CCER1_CC2P | TIM1_CCER1_CC2NP));
1120  030b c6525c        	ld	a,21084
1121  030e a40f          	and	a,#15
1122  0310 c7525c        	ld	21084,a
1123                     ; 238     TIM1->CCER1 |= (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER1_CC2E  ) | 
1123                     ; 239                              (uint8_t)(TIM1_OutputNState & TIM1_CCER1_CC2NE )) | 
1123                     ; 240                              (uint8_t)((uint8_t)(TIM1_OCPolarity  & TIM1_CCER1_CC2P  ) | 
1123                     ; 241                              (uint8_t)(TIM1_OCNPolarity & TIM1_CCER1_CC2NP )));
...
1144                     ; 244     TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM)) | 
1144                     ; 245                              (uint8_t)TIM1_OCMode);
1146  0335 c65259        	ld	a,21081
1147  0338 a48f          	and	a,#143
1148  033a 1a04          	or	a,(OFST+1,sp)
1149  033c c75259        	ld	21081,a
1150                     ; 248     TIM1->OISR &= (uint8_t)(~(TIM1_OISR_OIS2 | TIM1_OISR_OIS2N));
1152  033f c6526f        	ld	a,21103
1153  0342 a4f3          	and	a,#243
1154  0344 c7526f        	ld	21103,a
1155                     ; 250     TIM1->OISR |= (uint8_t)((uint8_t)(TIM1_OISR_OIS2 & TIM1_OCIdleState) | 
1155                     ; 251                             (uint8_t)(TIM1_OISR_OIS2N & TIM1_OCNIdleState));
...
1166                     ; 254     TIM1->CCR2H = (uint8_t)(TIM1_Pulse >> 8);
1168  0359 7b09          	ld	a,(OFST+6,sp)
1169  035b c75267        	ld	21095,a
1170                     ; 255     TIM1->CCR2L = (uint8_t)(TIM1_Pulse);
1172  035e 7b0a          	ld	a,(OFST+7,sp)
1173  0360 c75268        	ld	21096,a
1174                     ; 257 }
1177  0363 5b05          	addw	sp,#5
1178  0365 81            	ret
1283                     ; 278 void TIM1_OC3Init(TIM1_OCMode_TypeDef TIM1_OCMode,
1283                     ; 279                   TIM1_OutputState_TypeDef TIM1_OutputState,
1283                     ; 280                   TIM1_OutputNState_TypeDef TIM1_OutputNState,
1283                     ; 281                   uint16_t TIM1_Pulse,
1283                     ; 282                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
1283                     ; 283                   TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity,
1283                     ; 284                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState,
1283                     ; 285                   TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
1283                     ; 286 {
1284                     	switch	.text
...
1292                     ; 288     assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
...
1324  0399               L451:
1325                     ; 289     assert_param(IS_TIM1_OUTPUT_STATE_OK(TIM1_OutputState));
...
1344  03b6               L261:
1345                     ; 290     assert_param(IS_TIM1_OUTPUTN_STATE_OK(TIM1_OutputNState));
...
1364  03d3               L071:
1365                     ; 291     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
...
1384  03f0               L671:
1385                     ; 292     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
...
1404  040d               L402:
1405                     ; 293     assert_param(IS_TIM1_OCIDLE_STATE_OK(TIM1_OCIdleState));
...
1424  042a               L212:
1425                     ; 294     assert_param(IS_TIM1_OCNIDLE_STATE_OK(TIM1_OCNIdleState));
...
1444  0447               L022:
1445                     ; 298     TIM1->CCER2 &= (uint8_t)(~( TIM1_CCER2_CC3E | TIM1_CCER2_CC3NE | 
1445                     ; 299                                 TIM1_CCER2_CC3P | TIM1_CCER2_CC3NP));
1447  0447 c6525d        	ld	a,21085
1448  044a a4f0          	and	a,#240
1449  044c c7525d        	ld	21085,a
1450                     ; 302     TIM1->CCER2 |= (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState  & TIM1_CCER2_CC3E   ) |
1450                     ; 303                              (uint8_t)(TIM1_OutputNState & TIM1_CCER2_CC3NE  )) | 
1450                     ; 304                              (uint8_t)((uint8_t)(TIM1_OCPolarity   & TIM1_CCER2_CC3P   ) | 
1450                     ; 305                              (uint8_t)(TIM1_OCNPolarity  & TIM1_CCER2_CC3NP  )));
...
1471                     ; 308     TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM)) | 
1471                     ; 309                              (uint8_t)TIM1_OCMode);
1473  0471 c6525a        	ld	a,21082
1474  0474 a48f          	and	a,#143
1475  0476 1a04          	or	a,(OFST+1,sp)
1476  0478 c7525a        	ld	21082,a
1477                     ; 312     TIM1->OISR &= (uint8_t)(~(TIM1_OISR_OIS3 | TIM1_OISR_OIS3N));
1479  047b c6526f        	ld	a,21103
1480  047e a4cf          	and	a,#207
1481  0480 c7526f        	ld	21103,a
1482                     ; 314     TIM1->OISR |= (uint8_t)((uint8_t)(TIM1_OISR_OIS3 & TIM1_OCIdleState) | 
1482                     ; 315                             (uint8_t)(TIM1_OISR_OIS3N & TIM1_OCNIdleState));
...
1493                     ; 318     TIM1->CCR3H = (uint8_t)(TIM1_Pulse >> 8);
1495  0495 7b09          	ld	a,(OFST+6,sp)
1496  0497 c75269        	ld	21097,a
1497                     ; 319     TIM1->CCR3L = (uint8_t)(TIM1_Pulse);
1499  049a 7b0a          	ld	a,(OFST+7,sp)
1500  049c c7526a        	ld	21098,a
1501                     ; 321 }
1504  049f 5b05          	addw	sp,#5
1505  04a1 81            	ret
1580                     ; 336 void TIM1_OC4Init(TIM1_OCMode_TypeDef TIM1_OCMode,
1580                     ; 337                   TIM1_OutputState_TypeDef TIM1_OutputState,
1580                     ; 338                   uint16_t TIM1_Pulse,
1580                     ; 339                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
1580                     ; 340                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState)
1580                     ; 341 {
1581                     	switch	.text
...
1589                     ; 343     assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
...
1621  04d4               L032:
1622                     ; 344     assert_param(IS_TIM1_OUTPUT_STATE_OK(TIM1_OutputState));
...
1641  04f1               L632:
1642                     ; 345     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
...
1661  050e               L442:
1662                     ; 346     assert_param(IS_TIM1_OCIDLE_STATE_OK(TIM1_OCIdleState));
...
1681  052b               L252:
1682                     ; 349     TIM1->CCER2 &= (uint8_t)(~(TIM1_CCER2_CC4E | TIM1_CCER2_CC4P));
1684  052b c6525d        	ld	a,21085
1685  052e a4cf          	and	a,#207
1686  0530 c7525d        	ld	21085,a
1687                     ; 351     TIM1->CCER2 |= (uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER2_CC4E ) |  
1687                     ; 352                              (uint8_t)(TIM1_OCPolarity  & TIM1_CCER2_CC4P ));
...
1698                     ; 355     TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_OCM)) | 
1698                     ; 356                             TIM1_OCMode);
1700  0545 c6525b        	ld	a,21083
1701  0548 a48f          	and	a,#143
1702  054a 1a02          	or	a,(OFST+1,sp)
1703  054c c7525b        	ld	21083,a
1704                     ; 359     if (TIM1_OCIdleState != TIM1_OCIDLESTATE_RESET)
1706  054f 0d09          	tnz	(OFST+8,sp)
1707  0551 270a          	jreq	L734
1708                     ; 361         TIM1->OISR |= (uint8_t)(~TIM1_CCER2_CC4P);
1710  0553 c6526f        	ld	a,21103
1711  0556 aadf          	or	a,#223
1712  0558 c7526f        	ld	21103,a
1714  055b 2004          	jra	L144
1715  055d               L734:
1716                     ; 365         TIM1->OISR &= (uint8_t)(~TIM1_OISR_OIS4);
1718  055d 721d526f      	bres	21103,#6
1719  0561               L144:
1720                     ; 369     TIM1->CCR4H = (uint8_t)(TIM1_Pulse >> 8);
1722  0561 7b06          	ld	a,(OFST+5,sp)
1723  0563 c7526b        	ld	21099,a
1724                     ; 370     TIM1->CCR4L = (uint8_t)(TIM1_Pulse);
1726  0566 7b07          	ld	a,(OFST+6,sp)
1727  0568 c7526c        	ld	21100,a
1728                     ; 372 }
1731  056b 5b03          	addw	sp,#3
1732  056d 81            	ret
1938                     ; 387 void TIM1_BDTRConfig(TIM1_OSSIState_TypeDef TIM1_OSSIState,
1938                     ; 388                      TIM1_LockLevel_TypeDef TIM1_LockLevel,
1938                     ; 389                      uint8_t TIM1_DeadTime,
1938                     ; 390                      TIM1_BreakState_TypeDef TIM1_Break,
1938                     ; 391                      TIM1_BreakPolarity_TypeDef TIM1_BreakPolarity,
1938                     ; 392                      TIM1_AutomaticOutput_TypeDef TIM1_AutomaticOutput)
1938                     ; 393 {
1939                     	switch	.text
...
1947                     ; 395     assert_param(IS_TIM1_OSSI_STATE_OK(TIM1_OSSIState));
...
1967  058c               L262:
1968                     ; 396     assert_param(IS_TIM1_LOCK_LEVEL_OK(TIM1_LockLevel));
...
1993  05b5               L072:
1994                     ; 397     assert_param(IS_TIM1_BREAK_STATE_OK(TIM1_Break));
...
2013  05d2               L672:
2014                     ; 398     assert_param(IS_TIM1_BREAK_POLARITY_OK(TIM1_BreakPolarity));
...
2033  05ef               L403:
2034                     ; 399     assert_param(IS_TIM1_AUTOMATIC_OUTPUT_STATE_OK(TIM1_AutomaticOutput));
...
2053  060c               L213:
2054                     ; 401     TIM1->DTR = (uint8_t)(TIM1_DeadTime);
2056  060c 7b06          	ld	a,(OFST+5,sp)
2057  060e c7526e        	ld	21102,a
2058                     ; 405     TIM1->BKR  =  (uint8_t)((uint8_t)(TIM1_OSSIState | (uint8_t)TIM1_LockLevel)  | 
2058                     ; 406                             (uint8_t)((uint8_t)(TIM1_Break | (uint8_t)TIM1_BreakPolarity)  | 
2058                     ; 407                             (uint8_t)TIM1_AutomaticOutput));
...
2284                     ; 431     assert_param(IS_TIM1_CHANNEL_OK(TIM1_Channel));
...
2310  064c               L223:
2311                     ; 432     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_ICPolarity));
...
2330  0669               L033:
2331                     ; 433     assert_param(IS_TIM1_IC_SELECTION_OK(TIM1_ICSelection));
...
2354  068e               L633:
2355                     ; 434     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_ICPrescaler));
...
2380  06b7               L443:
2381                     ; 435     assert_param(IS_TIM1_IC_FILTER_OK(TIM1_ICFilter));
...
2397  06d0               L053:
2398                     ; 437     if (TIM1_Channel == TIM1_CHANNEL_1)
2400  06d0 0d01          	tnz	(OFST+1,sp)
2401  06d2 2614          	jrne	L176
2402                     ; 440         TI1_Config((uint8_t)TIM1_ICPolarity,
2402                     ; 441                    (uint8_t)TIM1_ICSelection,
2402                     ; 442                    (uint8_t)TIM1_ICFilter);
...
2412  06e0 84            	pop	a
2413                     ; 444         TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
2415  06e1 7b06          	ld	a,(OFST+6,sp)
2416  06e3 cd126b        	call	_TIM1_SetIC1Prescaler
2419  06e6 2046          	jra	L376
2420  06e8               L176:
2421                     ; 446     else if (TIM1_Channel == TIM1_CHANNEL_2)
2423  06e8 7b01          	ld	a,(OFST+1,sp)
2424  06ea a101          	cp	a,#1
2425  06ec 2614          	jrne	L576
2426                     ; 449         TI2_Config((uint8_t)TIM1_ICPolarity,
2426                     ; 450                    (uint8_t)TIM1_ICSelection,
2426                     ; 451                    (uint8_t)TIM1_ICFilter);
...
2436  06fa 84            	pop	a
2437                     ; 453         TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
2439  06fb 7b06          	ld	a,(OFST+6,sp)
2440  06fd cd129a        	call	_TIM1_SetIC2Prescaler
2443  0700 202c          	jra	L376
2444  0702               L576:
2445                     ; 455     else if (TIM1_Channel == TIM1_CHANNEL_3)
2447  0702 7b01          	ld	a,(OFST+1,sp)
2448  0704 a102          	cp	a,#2
2449  0706 2614          	jrne	L107
2450                     ; 458         TI3_Config((uint8_t)TIM1_ICPolarity,
2450                     ; 459                    (uint8_t)TIM1_ICSelection,
2450                     ; 460                    (uint8_t)TIM1_ICFilter);
...
2460  0714 84            	pop	a
2461                     ; 462         TIM1_SetIC3Prescaler(TIM1_ICPrescaler);
2463  0715 7b06          	ld	a,(OFST+6,sp)
2464  0717 cd12c9        	call	_TIM1_SetIC3Prescaler
2467  071a 2012          	jra	L376
2468  071c               L107:
2469                     ; 467         TI4_Config((uint8_t)TIM1_ICPolarity,
2469                     ; 468                    (uint8_t)TIM1_ICSelection,
2469                     ; 469                    (uint8_t)TIM1_ICFilter);
...
2479  0728 84            	pop	a
2480                     ; 471         TIM1_SetIC4Prescaler(TIM1_ICPrescaler);
...
2489  072e 85            	popw	x
2490  072f 81            	ret
2587                     ; 490 void TIM1_PWMIConfig(TIM1_Channel_TypeDef TIM1_Channel,
2587                     ; 491                      TIM1_ICPolarity_TypeDef TIM1_ICPolarity,
2587                     ; 492                      TIM1_ICSelection_TypeDef TIM1_ICSelection,
2587                     ; 493                      TIM1_ICPSC_TypeDef TIM1_ICPrescaler,
2587                     ; 494                      uint8_t TIM1_ICFilter)
2587                     ; 495 {
2588                     	switch	.text
...
2596                     ; 496     uint8_t icpolarity = TIM1_ICPOLARITY_RISING;
2598                     ; 497     uint8_t icselection = TIM1_ICSELECTION_DIRECTTI;
2600                     ; 500     assert_param(IS_TIM1_PWMI_CHANNEL_OK(TIM1_Channel));
...
2620  074e               L063:
2621                     ; 501     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_ICPolarity));
...
2640  076b               L663:
2641                     ; 502     assert_param(IS_TIM1_IC_SELECTION_OK(TIM1_ICSelection));
...
2664  0790               L473:
2665                     ; 503     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_ICPrescaler));
...
2742  07e7 84            	pop	a
2743                     ; 532         TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
2745  07e8 7b08          	ld	a,(OFST+6,sp)
2746  07ea cd126b        	call	_TIM1_SetIC1Prescaler
2748                     ; 535         TI2_Config(icpolarity, icselection, TIM1_ICFilter);
...
2758  07f9 84            	pop	a
2759                     ; 538         TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
2761  07fa 7b08          	ld	a,(OFST+6,sp)
2762  07fc cd129a        	call	_TIM1_SetIC2Prescaler
2765  07ff 2024          	jra	L567
2766  0801               L367:
2767                     ; 543         TI2_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSelection,
2767                     ; 544                    (uint8_t)TIM1_ICFilter);
...
2777  080d 84            	pop	a
2778                     ; 547         TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
2780  080e 7b08          	ld	a,(OFST+6,sp)
2781  0810 cd129a        	call	_TIM1_SetIC2Prescaler
2783                     ; 550         TI1_Config(icpolarity, icselection, TIM1_ICFilter);
...
2793  081f 84            	pop	a
2794                     ; 553         TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
...
2804  0827 81            	ret
2860                     ; 563 void TIM1_Cmd(FunctionalState NewState)
2860                     ; 564 {
2861                     	switch	.text
2862  0828               _TIM1_Cmd:
2864  0828 88            	push	a
2865       00000000      OFST:	set	0
2868                     ; 566     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2870  0829 4d            	tnz	a
...
2886  0843               L214:
2887                     ; 569     if (NewState != DISABLE)
2889  0843 0d01          	tnz	(OFST+1,sp)
2890  0845 2706          	jreq	L5101
2891                     ; 571         TIM1->CR1 |= TIM1_CR1_CEN;
2893  0847 72105250      	bset	21072,#0
2895  084b 2004          	jra	L7101
2896  084d               L5101:
2897                     ; 575         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_CEN);
2899  084d 72115250      	bres	21072,#0
2900  0851               L7101:
2901                     ; 577 }
2904  0851 84            	pop	a
2905  0852 81            	ret
2942                     ; 585 void TIM1_CtrlPWMOutputs(FunctionalState NewState)
2942                     ; 586 {
2943                     	switch	.text
2944  0853               _TIM1_CtrlPWMOutputs:
2946  0853 88            	push	a
2947       00000000      OFST:	set	0
2950                     ; 588     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2952  0854 4d            	tnz	a
...
2968  086e               L224:
2969                     ; 592     if (NewState != DISABLE)
2971  086e 0d01          	tnz	(OFST+1,sp)
2972  0870 2706          	jreq	L7301
2973                     ; 594         TIM1->BKR |= TIM1_BKR_MOE;
2975  0872 721e526d      	bset	21101,#7
2977  0876 2004          	jra	L1401
2978  0878               L7301:
2979                     ; 598         TIM1->BKR &= (uint8_t)(~TIM1_BKR_MOE);
2981  0878 721f526d      	bres	21101,#7
2982  087c               L1401:
2983                     ; 600 }
2986  087c 84            	pop	a
2987  087d 81            	ret
3095                     ; 619 void TIM1_ITConfig(TIM1_IT_TypeDef  TIM1_IT, FunctionalState NewState)
3095                     ; 620 {
3096                     	switch	.text
3097  087e               _TIM1_ITConfig:
3099  087e 89            	pushw	x
3100       00000000      OFST:	set	0
3103                     ; 622     assert_param(IS_TIM1_IT_OK(TIM1_IT));
...
3119  0896               L034:
3120                     ; 623     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
3162  08ca 85            	popw	x
3163  08cb 81            	ret
3187                     ; 642 void TIM1_InternalClockConfig(void)
3187                     ; 643 {
3188                     	switch	.text
3189  08cc               _TIM1_InternalClockConfig:
3193                     ; 645     TIM1->SMCR &= (uint8_t)(~TIM1_SMCR_SMS);
3195  08cc c65252        	ld	a,21074
3196  08cf a4f8          	and	a,#248
3197  08d1 c75252        	ld	21074,a
3198                     ; 646 }
3201  08d4 81            	ret
3319                     ; 664 void TIM1_ETRClockMode1Config(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
3319                     ; 665                               TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
3319                     ; 666                               uint8_t ExtTRGFilter)
3319                     ; 667 {
3320                     	switch	.text
3321  08d5               _TIM1_ETRClockMode1Config:
3323  08d5 89            	pushw	x
3324       00000000      OFST:	set	0
3327                     ; 669     assert_param(IS_TIM1_EXT_PRESCALER_OK(TIM1_ExtTRGPrescaler));
...
3353  08fc               L054:
3354                     ; 670     assert_param(IS_TIM1_EXT_POLARITY_OK(TIM1_ExtTRGPolarity));
...
3373  0919               L654:
3374                     ; 673     TIM1_ETRConfig(TIM1_ExtTRGPrescaler, TIM1_ExtTRGPolarity, ExtTRGFilter);
...
3384  0924 84            	pop	a
3385                     ; 676     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~(uint8_t)(TIM1_SMCR_SMS | TIM1_SMCR_TS )))
3385                     ; 677                            | (uint8_t)((uint8_t)TIM1_SLAVEMODE_EXTERNAL1 | TIM1_TS_ETRF ));
...
3394  092f 85            	popw	x
3395  0930 81            	ret
3454                     ; 696 void TIM1_ETRClockMode2Config(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
3454                     ; 697                               TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
3454                     ; 698                               uint8_t ExtTRGFilter)
3454                     ; 699 {
3455                     	switch	.text
3456  0931               _TIM1_ETRClockMode2Config:
3458  0931 89            	pushw	x
3459       00000000      OFST:	set	0
3462                     ; 701     assert_param(IS_TIM1_EXT_PRESCALER_OK(TIM1_ExtTRGPrescaler));
...
3488  0958               L664:
3489                     ; 702     assert_param(IS_TIM1_EXT_POLARITY_OK(TIM1_ExtTRGPolarity));
...
3508  0975               L474:
3509                     ; 705     TIM1_ETRConfig(TIM1_ExtTRGPrescaler, TIM1_ExtTRGPolarity, ExtTRGFilter);
...
3519  0980 84            	pop	a
3520                     ; 708     TIM1->ETR |= TIM1_ETR_ECE;
3522  0981 721c5253      	bset	21075,#6
3523                     ; 709 }
3526  0985 85            	popw	x
3527  0986 81            	ret
3584                     ; 727 void TIM1_ETRConfig(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
3584                     ; 728                     TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
3584                     ; 729                     uint8_t ExtTRGFilter)
3584                     ; 730 {
3585                     	switch	.text
3586  0987               _TIM1_ETRConfig:
3588  0987 89            	pushw	x
3589       00000000      OFST:	set	0
3592                     ; 732     assert_param(IS_TIM1_EXT_TRG_FILTER_OK(ExtTRGFilter));
...
3608  09a1               L205:
3609                     ; 734     TIM1->ETR |= (uint8_t)((uint8_t)(TIM1_ExtTRGPrescaler | (uint8_t)TIM1_ExtTRGPolarity )|
3609                     ; 735                       (uint8_t)ExtTRGFilter );
...
3619  09ad 85            	popw	x
3620  09ae 81            	ret
3710                     ; 753 void TIM1_TIxExternalClockConfig(TIM1_TIxExternalCLK1Source_TypeDef TIM1_TIxExternalCLKSource,
3710                     ; 754                                  TIM1_ICPolarity_TypeDef TIM1_ICPolarity,
3710                     ; 755                                  uint8_t ICFilter)
3710                     ; 756 {
3711                     	switch	.text
3712  09af               _TIM1_TIxExternalClockConfig:
3714  09af 89            	pushw	x
3715       00000000      OFST:	set	0
3718                     ; 758     assert_param(IS_TIM1_TIXCLK_SOURCE_OK(TIM1_TIxExternalCLKSource));
...
3741  09d2               L215:
3742                     ; 759     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_ICPolarity));
...
3761  09ef               L025:
3762                     ; 760     assert_param(IS_TIM1_IC_FILTER_OK(ICFilter));
...
3778  0a08               L425:
3779                     ; 763     if (TIM1_TIxExternalCLKSource == TIM1_TIXEXTERNALCLK1SOURCE_TI2)
3781  0a08 7b01          	ld	a,(OFST+1,sp)
3782  0a0a a160          	cp	a,#96
3783  0a0c 260f          	jrne	L3131
3784                     ; 765         TI2_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSELECTION_DIRECTTI, (uint8_t)ICFilter);
...
3796  0a1d               L3131:
3797                     ; 769         TI1_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSELECTION_DIRECTTI, (uint8_t)ICFilter);
...
3806  0a29 84            	pop	a
3807  0a2a               L5131:
3808                     ; 773     TIM1_SelectInputTrigger((TIM1_TS_TypeDef)TIM1_TIxExternalCLKSource);
3810  0a2a 7b01          	ld	a,(OFST+1,sp)
3811  0a2c ad0a          	call	_TIM1_SelectInputTrigger
3813                     ; 776     TIM1->SMCR |= (uint8_t)(TIM1_SLAVEMODE_EXTERNAL1);
...
3821  0a36 85            	popw	x
3822  0a37 81            	ret
3908                     ; 789 void TIM1_SelectInputTrigger(TIM1_TS_TypeDef TIM1_InputTriggerSource)
3908                     ; 790 {
3909                     	switch	.text
3910  0a38               _TIM1_SelectInputTrigger:
3912  0a38 88            	push	a
3913       00000000      OFST:	set	0
3916                     ; 792     assert_param(IS_TIM1_TRIGGER_SELECTION_OK(TIM1_InputTriggerSource));
...
3942  0a63               L435:
3943                     ; 795     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~TIM1_SMCR_TS)) | (uint8_t)TIM1_InputTriggerSource);
...
3952  0a6d 84            	pop	a
3953  0a6e 81            	ret
3990                     ; 806 void TIM1_UpdateDisableConfig(FunctionalState NewState)
3990                     ; 807 {
3991                     	switch	.text
3992  0a6f               _TIM1_UpdateDisableConfig:
3994  0a6f 88            	push	a
3995       00000000      OFST:	set	0
3998                     ; 809     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4000  0a70 4d            	tnz	a
...
4016  0a8a               L445:
4017                     ; 812     if (NewState != DISABLE)
4019  0a8a 0d01          	tnz	(OFST+1,sp)
4020  0a8c 2706          	jreq	L3731
4021                     ; 814         TIM1->CR1 |= TIM1_CR1_UDIS;
4023  0a8e 72125250      	bset	21072,#1
4025  0a92 2004          	jra	L5731
4026  0a94               L3731:
4027                     ; 818         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_UDIS);
4029  0a94 72135250      	bres	21072,#1
4030  0a98               L5731:
4031                     ; 820 }
4034  0a98 84            	pop	a
4035  0a99 81            	ret
4094                     ; 830 void TIM1_UpdateRequestConfig(TIM1_UpdateSource_TypeDef TIM1_UpdateSource)
4094                     ; 831 {
4095                     	switch	.text
4096  0a9a               _TIM1_UpdateRequestConfig:
4098  0a9a 88            	push	a
4099       00000000      OFST:	set	0
4102                     ; 833     assert_param(IS_TIM1_UPDATE_SOURCE_OK(TIM1_UpdateSource));
4104  0a9b 4d            	tnz	a
...
4120  0ab5               L455:
4121                     ; 836     if (TIM1_UpdateSource != TIM1_UPDATESOURCE_GLOBAL)
4123  0ab5 0d01          	tnz	(OFST+1,sp)
4124  0ab7 2706          	jreq	L5241
4125                     ; 838         TIM1->CR1 |= TIM1_CR1_URS;
4127  0ab9 72145250      	bset	21072,#2
4129  0abd 2004          	jra	L7241
4130  0abf               L5241:
4131                     ; 842         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_URS);
4133  0abf 72155250      	bres	21072,#2
4134  0ac3               L7241:
4135                     ; 844 }
4138  0ac3 84            	pop	a
4139  0ac4 81            	ret
4176                     ; 853 void TIM1_SelectHallSensor(FunctionalState NewState)
4176                     ; 854 {
4177                     	switch	.text
4178  0ac5               _TIM1_SelectHallSensor:
4180  0ac5 88            	push	a
4181       00000000      OFST:	set	0
4184                     ; 856     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4186  0ac6 4d            	tnz	a
...
4202  0ae0               L465:
4203                     ; 859     if (NewState != DISABLE)
4205  0ae0 0d01          	tnz	(OFST+1,sp)
4206  0ae2 2706          	jreq	L7441
4207                     ; 861         TIM1->CR2 |= TIM1_CR2_TI1S;
4209  0ae4 721e5251      	bset	21073,#7
4211  0ae8 2004          	jra	L1541
4212  0aea               L7441:
4213                     ; 865         TIM1->CR2 &= (uint8_t)(~TIM1_CR2_TI1S);
4215  0aea 721f5251      	bres	21073,#7
4216  0aee               L1541:
4217                     ; 867 }
4220  0aee 84            	pop	a
4221  0aef 81            	ret
4279                     ; 878 void TIM1_SelectOnePulseMode(TIM1_OPMode_TypeDef TIM1_OPMode)
4279                     ; 879 {
4280                     	switch	.text
4281  0af0               _TIM1_SelectOnePulseMode:
4283  0af0 88            	push	a
4284       00000000      OFST:	set	0
4287                     ; 881     assert_param(IS_TIM1_OPM_MODE_OK(TIM1_OPMode));
...
4305  0b0b               L475:
4306                     ; 884     if (TIM1_OPMode != TIM1_OPMODE_REPETITIVE)
4308  0b0b 0d01          	tnz	(OFST+1,sp)
4309  0b0d 2706          	jreq	L1051
4310                     ; 886         TIM1->CR1 |= TIM1_CR1_OPM;
4312  0b0f 72165250      	bset	21072,#3
4314  0b13 2004          	jra	L3051
4315  0b15               L1051:
4316                     ; 890         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_OPM);
4318  0b15 72175250      	bres	21072,#3
4319  0b19               L3051:
4320                     ; 893 }
4323  0b19 84            	pop	a
4324  0b1a 81            	ret
4423                     ; 909 void TIM1_SelectOutputTrigger(TIM1_TRGOSource_TypeDef TIM1_TRGOSource)
4423                     ; 910 {
4424                     	switch	.text
4425  0b1b               _TIM1_SelectOutputTrigger:
4427  0b1b 88            	push	a
4428       00000000      OFST:	set	0
4431                     ; 912     assert_param(IS_TIM1_TRGO_SOURCE_OK(TIM1_TRGOSource));
4433  0b1c 4d            	tnz	a
...
4459  0b4a               L406:
4460                     ; 915     TIM1->CR2 = (uint8_t)((uint8_t)(TIM1->CR2 & (uint8_t)(~TIM1_CR2_MMS)) | 
4460                     ; 916                           (uint8_t) TIM1_TRGOSource);
...
4469  0b54 84            	pop	a
4470  0b55 81            	ret
4545                     ; 929 void TIM1_SelectSlaveMode(TIM1_SlaveMode_TypeDef TIM1_SlaveMode)
4545                     ; 930 {
4546                     	switch	.text
4547  0b56               _TIM1_SelectSlaveMode:
4549  0b56 88            	push	a
4550       00000000      OFST:	set	0
4553                     ; 933     assert_param(IS_TIM1_SLAVE_MODE_OK(TIM1_SlaveMode));
...
4575  0b7a               L416:
4576                     ; 936     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~TIM1_SMCR_SMS)) |
4576                     ; 937                            (uint8_t)TIM1_SlaveMode);
...
4585  0b84 84            	pop	a
4586  0b85 81            	ret
4623                     ; 947 void TIM1_SelectMasterSlaveMode(FunctionalState NewState)
4623                     ; 948 {
4624                     	switch	.text
4625  0b86               _TIM1_SelectMasterSlaveMode:
4627  0b86 88            	push	a
4628       00000000      OFST:	set	0
4631                     ; 950     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4633  0b87 4d            	tnz	a
...
4649  0ba1               L426:
4650                     ; 953     if (NewState != DISABLE)
4652  0ba1 0d01          	tnz	(OFST+1,sp)
4653  0ba3 2706          	jreq	L5161
4654                     ; 955         TIM1->SMCR |= TIM1_SMCR_MSM;
4656  0ba5 721e5252      	bset	21074,#7
4658  0ba9 2004          	jra	L7161
4659  0bab               L5161:
4660                     ; 959         TIM1->SMCR &= (uint8_t)(~TIM1_SMCR_MSM);
4662  0bab 721f5252      	bres	21074,#7
4663  0baf               L7161:
4664                     ; 961 }
4667  0baf 84            	pop	a
4668  0bb0 81            	ret
4755                     ; 983 void TIM1_EncoderInterfaceConfig(TIM1_EncoderMode_TypeDef TIM1_EncoderMode,
4755                     ; 984                                  TIM1_ICPolarity_TypeDef TIM1_IC1Polarity,
4755                     ; 985                                  TIM1_ICPolarity_TypeDef TIM1_IC2Polarity)
4755                     ; 986 {
4756                     	switch	.text
4757  0bb1               _TIM1_EncoderInterfaceConfig:
4759  0bb1 89            	pushw	x
4760       00000000      OFST:	set	0
4763                     ; 990     assert_param(IS_TIM1_ENCODER_MODE_OK(TIM1_EncoderMode));
...
4786  0bd4               L436:
4787                     ; 991     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_IC1Polarity));
...
4806  0bf1               L246:
4807                     ; 992     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_IC2Polarity));
...
4826  0c0e               L056:
4827                     ; 995     if (TIM1_IC1Polarity != TIM1_ICPOLARITY_RISING)
4829  0c0e 0d02          	tnz	(OFST+2,sp)
4830  0c10 2706          	jreq	L1661
4831                     ; 997         TIM1->CCER1 |= TIM1_CCER1_CC1P;
4833  0c12 7212525c      	bset	21084,#1
4835  0c16 2004          	jra	L3661
4836  0c18               L1661:
4837                     ; 1001         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
4839  0c18 7213525c      	bres	21084,#1
4840  0c1c               L3661:
4841                     ; 1004     if (TIM1_IC2Polarity != TIM1_ICPOLARITY_RISING)
4843  0c1c 0d05          	tnz	(OFST+5,sp)
4844  0c1e 2706          	jreq	L5661
4845                     ; 1006         TIM1->CCER1 |= TIM1_CCER1_CC2P;
4847  0c20 721a525c      	bset	21084,#5
4849  0c24 2004          	jra	L7661
4850  0c26               L5661:
4851                     ; 1010         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
4853  0c26 721b525c      	bres	21084,#5
4854  0c2a               L7661:
4855                     ; 1013     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(TIM1_SMCR_MSM | TIM1_SMCR_TS))
4855                     ; 1014                            | (uint8_t) TIM1_EncoderMode);
4857  0c2a c65252        	ld	a,21074
4858  0c2d a4f0          	and	a,#240
4859  0c2f 1a01          	or	a,(OFST+1,sp)
4860  0c31 c75252        	ld	21074,a
4861                     ; 1017     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_CCxS)) 
4861                     ; 1018                             | (uint8_t) CCMR_TIxDirect_Set);
4863  0c34 c65258        	ld	a,21080
4864  0c37 a4fc          	and	a,#252
4865  0c39 aa01          	or	a,#1
4866  0c3b c75258        	ld	21080,a
4867                     ; 1019     TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_CCxS))
4867                     ; 1020                             | (uint8_t) CCMR_TIxDirect_Set);
...
4876  0c48 85            	popw	x
4877  0c49 81            	ret
4945                     ; 1035 void TIM1_PrescalerConfig(uint16_t Prescaler,
4945                     ; 1036                           TIM1_PSCReloadMode_TypeDef TIM1_PSCReloadMode)
4945                     ; 1037 {
4946                     	switch	.text
4947  0c4a               _TIM1_PrescalerConfig:
4949  0c4a 89            	pushw	x
4950       00000000      OFST:	set	0
4953                     ; 1039     assert_param(IS_TIM1_PRESCALER_RELOAD_OK(TIM1_PSCReloadMode));
...
4972  0c68               L066:
4973                     ; 1042     TIM1->PSCRH = (uint8_t)(Prescaler >> 8);
4975  0c68 7b01          	ld	a,(OFST+1,sp)
4976  0c6a c75260        	ld	21088,a
4977                     ; 1043     TIM1->PSCRL = (uint8_t)(Prescaler);
4979  0c6d 7b02          	ld	a,(OFST+2,sp)
4980  0c6f c75261        	ld	21089,a
4981                     ; 1046     TIM1->EGR = (uint8_t)TIM1_PSCReloadMode;
4983  0c72 7b05          	ld	a,(OFST+5,sp)
4984  0c74 c75257        	ld	21079,a
4985                     ; 1048 }
4988  0c77 85            	popw	x
4989  0c78 81            	ret
5026                     ; 1061 void TIM1_CounterModeConfig(TIM1_CounterMode_TypeDef TIM1_CounterMode)
5026                     ; 1062 {
5027                     	switch	.text
5028  0c79               _TIM1_CounterModeConfig:
5030  0c79 88            	push	a
5031       00000000      OFST:	set	0
5034                     ; 1064     assert_param(IS_TIM1_COUNTER_MODE_OK(TIM1_CounterMode));
5036  0c7a 4d            	tnz	a
...
5058  0ca0               L076:
5059                     ; 1068     TIM1->CR1 = (uint8_t)((uint8_t)(TIM1->CR1 & (uint8_t)((uint8_t)(~TIM1_CR1_CMS) & (uint8_t)(~TIM1_CR1_DIR)))
5059                     ; 1069                           | (uint8_t)TIM1_CounterMode);
...
5068  0caa 84            	pop	a
5069  0cab 81            	ret
5128                     ; 1081 void TIM1_ForcedOC1Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
5128                     ; 1082 {
5129                     	switch	.text
5130  0cac               _TIM1_ForcedOC1Config:
5132  0cac 88            	push	a
5133       00000000      OFST:	set	0
5136                     ; 1084     assert_param(IS_TIM1_FORCED_ACTION_OK(TIM1_ForcedAction));
...
5154  0cc8               L007:
5155                     ; 1087     TIM1->CCMR1 =  (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM))|
5155                     ; 1088                              (uint8_t)TIM1_ForcedAction);
...
5164  0cd2 84            	pop	a
5165  0cd3 81            	ret
5202                     ; 1100 void TIM1_ForcedOC2Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
5202                     ; 1101 {
5203                     	switch	.text
5204  0cd4               _TIM1_ForcedOC2Config:
5206  0cd4 88            	push	a
5207       00000000      OFST:	set	0
5210                     ; 1103     assert_param(IS_TIM1_FORCED_ACTION_OK(TIM1_ForcedAction));
...
5228  0cf0               L017:
5229                     ; 1106     TIM1->CCMR2  =  (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM))
5229                     ; 1107                               | (uint8_t)TIM1_ForcedAction);
...
5238  0cfa 84            	pop	a
5239  0cfb 81            	ret
5276                     ; 1120 void TIM1_ForcedOC3Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
5276                     ; 1121 {
5277                     	switch	.text
5278  0cfc               _TIM1_ForcedOC3Config:
5280  0cfc 88            	push	a
5281       00000000      OFST:	set	0
5284                     ; 1123     assert_param(IS_TIM1_FORCED_ACTION_OK(TIM1_ForcedAction));
...
5302  0d18               L027:
5303                     ; 1126     TIM1->CCMR3  =  (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM))  
5303                     ; 1127                               | (uint8_t)TIM1_ForcedAction);
...
5312  0d22 84            	pop	a
5313  0d23 81            	ret
5350                     ; 1140 void TIM1_ForcedOC4Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
5350                     ; 1141 {
5351                     	switch	.text
5352  0d24               _TIM1_ForcedOC4Config:
5354  0d24 88            	push	a
5355       00000000      OFST:	set	0
5358                     ; 1143     assert_param(IS_TIM1_FORCED_ACTION_OK(TIM1_ForcedAction));
...
5376  0d40               L037:
5377                     ; 1146     TIM1->CCMR4  =  (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_OCM)) 
5377                     ; 1147                               | (uint8_t)TIM1_ForcedAction);
...
5386  0d4a 84            	pop	a
5387  0d4b 81            	ret
5424                     ; 1157 void TIM1_ARRPreloadConfig(FunctionalState NewState)
5424                     ; 1158 {
5425                     	switch	.text
5426  0d4c               _TIM1_ARRPreloadConfig:
5428  0d4c 88            	push	a
5429       00000000      OFST:	set	0
5432                     ; 1160     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5434  0d4d 4d            	tnz	a
...
5450  0d67               L047:
5451                     ; 1163     if (NewState != DISABLE)
5453  0d67 0d01          	tnz	(OFST+1,sp)
5454  0d69 2706          	jreq	L7502
5455                     ; 1165         TIM1->CR1 |= TIM1_CR1_ARPE;
5457  0d6b 721e5250      	bset	21072,#7
5459  0d6f 2004          	jra	L1602
5460  0d71               L7502:
5461                     ; 1169         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_ARPE);
5463  0d71 721f5250      	bres	21072,#7
5464  0d75               L1602:
5465                     ; 1171 }
5468  0d75 84            	pop	a
5469  0d76 81            	ret
5505                     ; 1180 void TIM1_SelectCOM(FunctionalState NewState)
5505                     ; 1181 {
5506                     	switch	.text
5507  0d77               _TIM1_SelectCOM:
5509  0d77 88            	push	a
5510       00000000      OFST:	set	0
5513                     ; 1183     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5515  0d78 4d            	tnz	a
...
5531  0d92               L057:
5532                     ; 1186     if (NewState != DISABLE)
5534  0d92 0d01          	tnz	(OFST+1,sp)
5535  0d94 2706          	jreq	L1012
5536                     ; 1188         TIM1->CR2 |= TIM1_CR2_COMS;
5538  0d96 72145251      	bset	21073,#2
5540  0d9a 2004          	jra	L3012
5541  0d9c               L1012:
5542                     ; 1192         TIM1->CR2 &= (uint8_t)(~TIM1_CR2_COMS);
5544  0d9c 72155251      	bres	21073,#2
5545  0da0               L3012:
5546                     ; 1194 }
5549  0da0 84            	pop	a
5550  0da1 81            	ret
5587                     ; 1202 void TIM1_CCPreloadControl(FunctionalState NewState)
5587                     ; 1203 {
5588                     	switch	.text
5589  0da2               _TIM1_CCPreloadControl:
5591  0da2 88            	push	a
5592       00000000      OFST:	set	0
5595                     ; 1205     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5597  0da3 4d            	tnz	a
...
5613  0dbd               L067:
5614                     ; 1208     if (NewState != DISABLE)
5616  0dbd 0d01          	tnz	(OFST+1,sp)
5617  0dbf 2706          	jreq	L3212
5618                     ; 1210         TIM1->CR2 |= TIM1_CR2_CCPC;
5620  0dc1 72105251      	bset	21073,#0
5622  0dc5 2004          	jra	L5212
5623  0dc7               L3212:
5624                     ; 1214         TIM1->CR2 &= (uint8_t)(~TIM1_CR2_CCPC);
5626  0dc7 72115251      	bres	21073,#0
5627  0dcb               L5212:
5628                     ; 1216 }
5631  0dcb 84            	pop	a
5632  0dcc 81            	ret
5669                     ; 1225 void TIM1_OC1PreloadConfig(FunctionalState NewState)
5669                     ; 1226 {
5670                     	switch	.text
5671  0dcd               _TIM1_OC1PreloadConfig:
5673  0dcd 88            	push	a
5674       00000000      OFST:	set	0
5677                     ; 1228     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5679  0dce 4d            	tnz	a
...
5695  0de8               L077:
5696                     ; 1231     if (NewState != DISABLE)
5698  0de8 0d01          	tnz	(OFST+1,sp)
5699  0dea 2706          	jreq	L5412
5700                     ; 1233         TIM1->CCMR1 |= TIM1_CCMR_OCxPE;
5702  0dec 72165258      	bset	21080,#3
5704  0df0 2004          	jra	L7412
5705  0df2               L5412:
5706                     ; 1237         TIM1->CCMR1 &= (uint8_t)(~TIM1_CCMR_OCxPE);
5708  0df2 72175258      	bres	21080,#3
5709  0df6               L7412:
5710                     ; 1239 }
5713  0df6 84            	pop	a
5714  0df7 81            	ret
5751                     ; 1248 void TIM1_OC2PreloadConfig(FunctionalState NewState)
5751                     ; 1249 {
5752                     	switch	.text
5753  0df8               _TIM1_OC2PreloadConfig:
5755  0df8 88            	push	a
5756       00000000      OFST:	set	0
5759                     ; 1251     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5761  0df9 4d            	tnz	a
...
5777  0e13               L0001:
5778                     ; 1254     if (NewState != DISABLE)
5780  0e13 0d01          	tnz	(OFST+1,sp)
5781  0e15 2706          	jreq	L7612
5782                     ; 1256         TIM1->CCMR2 |= TIM1_CCMR_OCxPE;
5784  0e17 72165259      	bset	21081,#3
5786  0e1b 2004          	jra	L1712
5787  0e1d               L7612:
5788                     ; 1260         TIM1->CCMR2 &= (uint8_t)(~TIM1_CCMR_OCxPE);
5790  0e1d 72175259      	bres	21081,#3
5791  0e21               L1712:
5792                     ; 1262 }
5795  0e21 84            	pop	a
5796  0e22 81            	ret
5833                     ; 1271 void TIM1_OC3PreloadConfig(FunctionalState NewState)
5833                     ; 1272 {
5834                     	switch	.text
5835  0e23               _TIM1_OC3PreloadConfig:
5837  0e23 88            	push	a
5838       00000000      OFST:	set	0
5841                     ; 1274     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5843  0e24 4d            	tnz	a
...
5859  0e3e               L0101:
5860                     ; 1277     if (NewState != DISABLE)
5862  0e3e 0d01          	tnz	(OFST+1,sp)
5863  0e40 2706          	jreq	L1122
5864                     ; 1279         TIM1->CCMR3 |= TIM1_CCMR_OCxPE;
5866  0e42 7216525a      	bset	21082,#3
5868  0e46 2004          	jra	L3122
5869  0e48               L1122:
5870                     ; 1283         TIM1->CCMR3 &= (uint8_t)(~TIM1_CCMR_OCxPE);
5872  0e48 7217525a      	bres	21082,#3
5873  0e4c               L3122:
5874                     ; 1285 }
5877  0e4c 84            	pop	a
5878  0e4d 81            	ret
5915                     ; 1295 void TIM1_OC4PreloadConfig(FunctionalState NewState)
5915                     ; 1296 {
5916                     	switch	.text
5917  0e4e               _TIM1_OC4PreloadConfig:
5919  0e4e 88            	push	a
5920       00000000      OFST:	set	0
5923                     ; 1298     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5925  0e4f 4d            	tnz	a
...
5941  0e69               L0201:
5942                     ; 1301     if (NewState != DISABLE)
5944  0e69 0d01          	tnz	(OFST+1,sp)
5945  0e6b 2706          	jreq	L3322
5946                     ; 1303         TIM1->CCMR4 |= TIM1_CCMR_OCxPE;
5948  0e6d 7216525b      	bset	21083,#3
5950  0e71 2004          	jra	L5322
5951  0e73               L3322:
5952                     ; 1307         TIM1->CCMR4 &= (uint8_t)(~TIM1_CCMR_OCxPE);
5954  0e73 7217525b      	bres	21083,#3
5955  0e77               L5322:
5956                     ; 1309 }
5959  0e77 84            	pop	a
5960  0e78 81            	ret
5996                     ; 1317 void TIM1_OC1FastConfig(FunctionalState NewState)
5996                     ; 1318 {
5997                     	switch	.text
5998  0e79               _TIM1_OC1FastConfig:
6000  0e79 88            	push	a
6001       00000000      OFST:	set	0
6004                     ; 1320     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
6006  0e7a 4d            	tnz	a
...
6022  0e94               L0301:
6023                     ; 1323     if (NewState != DISABLE)
6025  0e94 0d01          	tnz	(OFST+1,sp)
6026  0e96 2706          	jreq	L5522
6027                     ; 1325         TIM1->CCMR1 |= TIM1_CCMR_OCxFE;
6029  0e98 72145258      	bset	21080,#2
6031  0e9c 2004          	jra	L7522
6032  0e9e               L5522:
6033                     ; 1329         TIM1->CCMR1 &= (uint8_t)(~TIM1_CCMR_OCxFE);
6035  0e9e 72155258      	bres	21080,#2
6036  0ea2               L7522:
6037                     ; 1331 }
6040  0ea2 84            	pop	a
6041  0ea3 81            	ret
6077                     ; 1341 void TIM1_OC2FastConfig(FunctionalState NewState)
6077                     ; 1342 {
6078                     	switch	.text
6079  0ea4               _TIM1_OC2FastConfig:
6081  0ea4 88            	push	a
6082       00000000      OFST:	set	0
6085                     ; 1344     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
6087  0ea5 4d            	tnz	a
...
6103  0ebf               L0401:
6104                     ; 1347     if (NewState != DISABLE)
6106  0ebf 0d01          	tnz	(OFST+1,sp)
6107  0ec1 2706          	jreq	L7722
6108                     ; 1349         TIM1->CCMR2 |= TIM1_CCMR_OCxFE;
6110  0ec3 72145259      	bset	21081,#2
6112  0ec7 2004          	jra	L1032
6113  0ec9               L7722:
6114                     ; 1353         TIM1->CCMR2 &= (uint8_t)(~TIM1_CCMR_OCxFE);
6116  0ec9 72155259      	bres	21081,#2
6117  0ecd               L1032:
6118                     ; 1355 }
6121  0ecd 84            	pop	a
6122  0ece 81            	ret
6158                     ; 1364 void TIM1_OC3FastConfig(FunctionalState NewState)
6158                     ; 1365 {
6159                     	switch	.text
6160  0ecf               _TIM1_OC3FastConfig:
6162  0ecf 88            	push	a
6163       00000000      OFST:	set	0
6166                     ; 1367     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
6168  0ed0 4d            	tnz	a
...
6184  0eea               L0501:
6185                     ; 1370     if (NewState != DISABLE)
6187  0eea 0d01          	tnz	(OFST+1,sp)
6188  0eec 2706          	jreq	L1232
6189                     ; 1372         TIM1->CCMR3 |= TIM1_CCMR_OCxFE;
6191  0eee 7214525a      	bset	21082,#2
6193  0ef2 2004          	jra	L3232
6194  0ef4               L1232:
6195                     ; 1376         TIM1->CCMR3 &= (uint8_t)(~TIM1_CCMR_OCxFE);
6197  0ef4 7215525a      	bres	21082,#2
6198  0ef8               L3232:
6199                     ; 1378 }
6202  0ef8 84            	pop	a
6203  0ef9 81            	ret
6239                     ; 1387 void TIM1_OC4FastConfig(FunctionalState NewState)
6239                     ; 1388 {
6240                     	switch	.text
6241  0efa               _TIM1_OC4FastConfig:
6243  0efa 88            	push	a
6244       00000000      OFST:	set	0
6247                     ; 1390     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
6249  0efb 4d            	tnz	a
...
6265  0f15               L0601:
6266                     ; 1393     if (NewState != DISABLE)
6268  0f15 0d01          	tnz	(OFST+1,sp)
6269  0f17 2706          	jreq	L3432
6270                     ; 1395         TIM1->CCMR4 |= TIM1_CCMR_OCxFE;
6272  0f19 7214525b      	bset	21083,#2
6274  0f1d 2004          	jra	L5432
6275  0f1f               L3432:
6276                     ; 1399         TIM1->CCMR4 &= (uint8_t)(~TIM1_CCMR_OCxFE);
6278  0f1f 7215525b      	bres	21083,#2
6279  0f23               L5432:
6280                     ; 1401 }
6283  0f23 84            	pop	a
6284  0f24 81            	ret
6390                     ; 1418 void TIM1_GenerateEvent(TIM1_EventSource_TypeDef TIM1_EventSource)
6390                     ; 1419 {
6391                     	switch	.text
6392  0f25               _TIM1_GenerateEvent:
6394  0f25 88            	push	a
6395       00000000      OFST:	set	0
6398                     ; 1421     assert_param(IS_TIM1_EVENT_SOURCE_OK(TIM1_EventSource));
6400  0f26 4d            	tnz	a
6401  0f27 2703          	jreq	L4601
6402  0f29 4f            	clr	a
6403  0f2a 2010          	jra	L6601
6404  0f2c               L4601:
6405  0f2c ae058d        	ldw	x,#1421
...
6413  0f3c               L6601:
6414                     ; 1424     TIM1->EGR = (uint8_t)TIM1_EventSource;
6416  0f3c 7b01          	ld	a,(OFST+1,sp)
6417  0f3e c75257        	ld	21079,a
6418                     ; 1425 }
6421  0f41 84            	pop	a
6422  0f42 81            	ret
6459                     ; 1436 void TIM1_OC1PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
6459                     ; 1437 {
6460                     	switch	.text
6461  0f43               _TIM1_OC1PolarityConfig:
6463  0f43 88            	push	a
6464       00000000      OFST:	set	0
6467                     ; 1439     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
6469  0f44 4d            	tnz	a
...
6485  0f5e               L6701:
6486                     ; 1442     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
6488  0f5e 0d01          	tnz	(OFST+1,sp)
6489  0f60 2706          	jreq	L7242
6490                     ; 1444         TIM1->CCER1 |= TIM1_CCER1_CC1P;
6492  0f62 7212525c      	bset	21084,#1
6494  0f66 2004          	jra	L1342
6495  0f68               L7242:
6496                     ; 1448         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
6498  0f68 7213525c      	bres	21084,#1
6499  0f6c               L1342:
6500                     ; 1450 }
6503  0f6c 84            	pop	a
6504  0f6d 81            	ret
6541                     ; 1461 void TIM1_OC1NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
6541                     ; 1462 {
6542                     	switch	.text
6543  0f6e               _TIM1_OC1NPolarityConfig:
6545  0f6e 88            	push	a
6546       00000000      OFST:	set	0
6549                     ; 1464     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
6551  0f6f 4d            	tnz	a
...
6567  0f89               L6011:
6568                     ; 1467     if (TIM1_OCNPolarity != TIM1_OCNPOLARITY_HIGH)
6570  0f89 0d01          	tnz	(OFST+1,sp)
6571  0f8b 2706          	jreq	L1542
6572                     ; 1469         TIM1->CCER1 |= TIM1_CCER1_CC1NP;
6574  0f8d 7216525c      	bset	21084,#3
6576  0f91 2004          	jra	L3542
6577  0f93               L1542:
6578                     ; 1473         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1NP);
6580  0f93 7217525c      	bres	21084,#3
6581  0f97               L3542:
6582                     ; 1475 }
6585  0f97 84            	pop	a
6586  0f98 81            	ret
6623                     ; 1486 void TIM1_OC2PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
6623                     ; 1487 {
6624                     	switch	.text
6625  0f99               _TIM1_OC2PolarityConfig:
6627  0f99 88            	push	a
6628       00000000      OFST:	set	0
6631                     ; 1489     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
6633  0f9a 4d            	tnz	a
...
6649  0fb4               L6111:
6650                     ; 1492     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
6652  0fb4 0d01          	tnz	(OFST+1,sp)
6653  0fb6 2706          	jreq	L3742
6654                     ; 1494         TIM1->CCER1 |= TIM1_CCER1_CC2P;
6656  0fb8 721a525c      	bset	21084,#5
6658  0fbc 2004          	jra	L5742
6659  0fbe               L3742:
6660                     ; 1498         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
6662  0fbe 721b525c      	bres	21084,#5
6663  0fc2               L5742:
6664                     ; 1500 }
6667  0fc2 84            	pop	a
6668  0fc3 81            	ret
6705                     ; 1510 void TIM1_OC2NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
6705                     ; 1511 {
6706                     	switch	.text
6707  0fc4               _TIM1_OC2NPolarityConfig:
6709  0fc4 88            	push	a
6710       00000000      OFST:	set	0
6713                     ; 1513     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
6715  0fc5 4d            	tnz	a
...
6731  0fdf               L6211:
6732                     ; 1516     if (TIM1_OCNPolarity != TIM1_OCNPOLARITY_HIGH)
6734  0fdf 0d01          	tnz	(OFST+1,sp)
6735  0fe1 2706          	jreq	L5152
6736                     ; 1518         TIM1->CCER1 |= TIM1_CCER1_CC2NP;
6738  0fe3 721e525c      	bset	21084,#7
6740  0fe7 2004          	jra	L7152
6741  0fe9               L5152:
6742                     ; 1522         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2NP);
6744  0fe9 721f525c      	bres	21084,#7
6745  0fed               L7152:
6746                     ; 1524 }
6749  0fed 84            	pop	a
6750  0fee 81            	ret
6787                     ; 1535 void TIM1_OC3PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
6787                     ; 1536 {
6788                     	switch	.text
6789  0fef               _TIM1_OC3PolarityConfig:
6791  0fef 88            	push	a
6792       00000000      OFST:	set	0
6795                     ; 1538     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
6797  0ff0 4d            	tnz	a
...
6813  100a               L6311:
6814                     ; 1541     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
6816  100a 0d01          	tnz	(OFST+1,sp)
6817  100c 2706          	jreq	L7352
6818                     ; 1543         TIM1->CCER2 |= TIM1_CCER2_CC3P;
6820  100e 7212525d      	bset	21085,#1
6822  1012 2004          	jra	L1452
6823  1014               L7352:
6824                     ; 1547         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3P);
6826  1014 7213525d      	bres	21085,#1
6827  1018               L1452:
6828                     ; 1549 }
6831  1018 84            	pop	a
6832  1019 81            	ret
6869                     ; 1560 void TIM1_OC3NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
6869                     ; 1561 {
6870                     	switch	.text
6871  101a               _TIM1_OC3NPolarityConfig:
6873  101a 88            	push	a
6874       00000000      OFST:	set	0
6877                     ; 1563     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
6879  101b 4d            	tnz	a
...
6895  1035               L6411:
6896                     ; 1566     if (TIM1_OCNPolarity != TIM1_OCNPOLARITY_HIGH)
6898  1035 0d01          	tnz	(OFST+1,sp)
6899  1037 2706          	jreq	L1652
6900                     ; 1568         TIM1->CCER2 |= TIM1_CCER2_CC3NP;
6902  1039 7216525d      	bset	21085,#3
6904  103d 2004          	jra	L3652
6905  103f               L1652:
6906                     ; 1572         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3NP);
6908  103f 7217525d      	bres	21085,#3
6909  1043               L3652:
6910                     ; 1574 }
6913  1043 84            	pop	a
6914  1044 81            	ret
6951                     ; 1584 void TIM1_OC4PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
6951                     ; 1585 {
6952                     	switch	.text
6953  1045               _TIM1_OC4PolarityConfig:
6955  1045 88            	push	a
6956       00000000      OFST:	set	0
6959                     ; 1587     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
6961  1046 4d            	tnz	a
...
6977  1060               L6511:
6978                     ; 1590     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
6980  1060 0d01          	tnz	(OFST+1,sp)
6981  1062 2706          	jreq	L3062
6982                     ; 1592         TIM1->CCER2 |= TIM1_CCER2_CC4P;
6984  1064 721a525d      	bset	21085,#5
6986  1068 2004          	jra	L5062
6987  106a               L3062:
6988                     ; 1596         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4P);
6990  106a 721b525d      	bres	21085,#5
6991  106e               L5062:
6992                     ; 1598 }
6995  106e 84            	pop	a
6996  106f 81            	ret
7042                     ; 1613 void TIM1_CCxCmd(TIM1_Channel_TypeDef TIM1_Channel, FunctionalState NewState)
7042                     ; 1614 {
7043                     	switch	.text
7044  1070               _TIM1_CCxCmd:
7046  1070 89            	pushw	x
7047       00000000      OFST:	set	0
7050                     ; 1616     assert_param(IS_TIM1_CHANNEL_OK(TIM1_Channel));
...
7076  1097               L6611:
7077                     ; 1617     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
7251  1126               L4021:
7252                     ; 1685     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
7409  11a4               L2221:
7410                     ; 1751     assert_param(IS_TIM1_OCM_OK(TIM1_OCMode));
...
7447  11e5               L0321:
7448                     ; 1753     if (TIM1_Channel == TIM1_CHANNEL_1)
7450  11e5 0d01          	tnz	(OFST+1,sp)
7451  11e7 2610          	jrne	L5572
7452                     ; 1756         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1E);
7454  11e9 7211525c      	bres	21084,#0
7455                     ; 1759         TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM)) 
7455                     ; 1760                                 | (uint8_t)TIM1_OCMode);
...
7463  11f9               L5572:
7464                     ; 1762     else if (TIM1_Channel == TIM1_CHANNEL_2)
7466  11f9 7b01          	ld	a,(OFST+1,sp)
7467  11fb a101          	cp	a,#1
7468  11fd 2610          	jrne	L1672
7469                     ; 1765         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2E);
7471  11ff 7219525c      	bres	21084,#4
7472                     ; 1768         TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM))
7472                     ; 1769                                 | (uint8_t)TIM1_OCMode);
...
7480  120f               L1672:
7481                     ; 1771     else if (TIM1_Channel == TIM1_CHANNEL_3)
7483  120f 7b01          	ld	a,(OFST+1,sp)
7484  1211 a102          	cp	a,#2
7485  1213 2610          	jrne	L5672
7486                     ; 1774         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3E);
7488  1215 7211525d      	bres	21085,#0
7489                     ; 1777         TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM)) 
7489                     ; 1778                                 | (uint8_t)TIM1_OCMode);
...
7497  1225               L5672:
7498                     ; 1783         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4E);
7500  1225 7219525d      	bres	21085,#4
7501                     ; 1786         TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_OCM)) 
7501                     ; 1787                                 | (uint8_t)TIM1_OCMode);
...
7511  1233 85            	popw	x
7512  1234 81            	ret
7546                     ; 1798 void TIM1_SetCounter(uint16_t Counter)
7546                     ; 1799 {
7547                     	switch	.text
7548  1235               _TIM1_SetCounter:
7552                     ; 1801     TIM1->CNTRH = (uint8_t)(Counter >> 8);
7554  1235 9e            	ld	a,xh
7555  1236 c7525e        	ld	21086,a
7556                     ; 1802     TIM1->CNTRL = (uint8_t)(Counter);
7558  1239 9f            	ld	a,xl
7559  123a c7525f        	ld	21087,a
7560                     ; 1804 }
7563  123d 81            	ret
7597                     ; 1813 void TIM1_SetAutoreload(uint16_t Autoreload)
7597                     ; 1814 {
7598                     	switch	.text
7599  123e               _TIM1_SetAutoreload:
7603                     ; 1817     TIM1->ARRH = (uint8_t)(Autoreload >> 8);
7605  123e 9e            	ld	a,xh
7606  123f c75262        	ld	21090,a
7607                     ; 1818     TIM1->ARRL = (uint8_t)(Autoreload);
7609  1242 9f            	ld	a,xl
7610  1243 c75263        	ld	21091,a
7611                     ; 1820 }
7614  1246 81            	ret
7648                     ; 1829 void TIM1_SetCompare1(uint16_t Compare1)
7648                     ; 1830 {
7649                     	switch	.text
7650  1247               _TIM1_SetCompare1:
7654                     ; 1832     TIM1->CCR1H = (uint8_t)(Compare1 >> 8);
7656  1247 9e            	ld	a,xh
7657  1248 c75265        	ld	21093,a
7658                     ; 1833     TIM1->CCR1L = (uint8_t)(Compare1);
7660  124b 9f            	ld	a,xl
7661  124c c75266        	ld	21094,a
7662                     ; 1835 }
7665  124f 81            	ret
7699                     ; 1844 void TIM1_SetCompare2(uint16_t Compare2)
7699                     ; 1845 {
7700                     	switch	.text
7701  1250               _TIM1_SetCompare2:
7705                     ; 1847     TIM1->CCR2H = (uint8_t)(Compare2 >> 8);
7707  1250 9e            	ld	a,xh
7708  1251 c75267        	ld	21095,a
7709                     ; 1848     TIM1->CCR2L = (uint8_t)(Compare2);
7711  1254 9f            	ld	a,xl
7712  1255 c75268        	ld	21096,a
7713                     ; 1850 }
7716  1258 81            	ret
7750                     ; 1859 void TIM1_SetCompare3(uint16_t Compare3)
7750                     ; 1860 {
7751                     	switch	.text
7752  1259               _TIM1_SetCompare3:
7756                     ; 1862     TIM1->CCR3H = (uint8_t)(Compare3 >> 8);
7758  1259 9e            	ld	a,xh
7759  125a c75269        	ld	21097,a
7760                     ; 1863     TIM1->CCR3L = (uint8_t)(Compare3);
7762  125d 9f            	ld	a,xl
7763  125e c7526a        	ld	21098,a
7764                     ; 1865 }
7767  1261 81            	ret
7801                     ; 1874 void TIM1_SetCompare4(uint16_t Compare4)
7801                     ; 1875 {
7802                     	switch	.text
7803  1262               _TIM1_SetCompare4:
7807                     ; 1877     TIM1->CCR4H = (uint8_t)(Compare4 >> 8);
7809  1262 9e            	ld	a,xh
7810  1263 c7526b        	ld	21099,a
7811                     ; 1878     TIM1->CCR4L = (uint8_t)(Compare4);
7813  1266 9f            	ld	a,xl
7814  1267 c7526c        	ld	21100,a
7815                     ; 1879 }
7818  126a 81            	ret
7855                     ; 1892 void TIM1_SetIC1Prescaler(TIM1_ICPSC_TypeDef TIM1_IC1Prescaler)
7855                     ; 1893 {
7856                     	switch	.text
7857  126b               _TIM1_SetIC1Prescaler:
7859  126b 88            	push	a
7860       00000000      OFST:	set	0
7863                     ; 1895     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC1Prescaler));
7865  126c 4d            	tnz	a
...
7885  128e               L4521:
7886                     ; 1898     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_ICxPSC)) 
7886                     ; 1899                             | (uint8_t)TIM1_IC1Prescaler);
...
7895  1298 84            	pop	a
7896  1299 81            	ret
7933                     ; 1913 void TIM1_SetIC2Prescaler(TIM1_ICPSC_TypeDef TIM1_IC2Prescaler)
7933                     ; 1914 {
7934                     	switch	.text
7935  129a               _TIM1_SetIC2Prescaler:
7937  129a 88            	push	a
7938       00000000      OFST:	set	0
7941                     ; 1917     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC2Prescaler));
7943  129b 4d            	tnz	a
...
7963  12bd               L4621:
7964                     ; 1920     TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_ICxPSC))
7964                     ; 1921                             | (uint8_t)TIM1_IC2Prescaler);
...
7973  12c7 84            	pop	a
7974  12c8 81            	ret
8011                     ; 1935 void TIM1_SetIC3Prescaler(TIM1_ICPSC_TypeDef TIM1_IC3Prescaler)
8011                     ; 1936 {
8012                     	switch	.text
8013  12c9               _TIM1_SetIC3Prescaler:
8015  12c9 88            	push	a
8016       00000000      OFST:	set	0
8019                     ; 1939     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC3Prescaler));
8021  12ca 4d            	tnz	a
...
8041  12ec               L4721:
8042                     ; 1942     TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_ICxPSC)) | 
8042                     ; 1943                             (uint8_t)TIM1_IC3Prescaler);
...
8051  12f6 84            	pop	a
8052  12f7 81            	ret
8089                     ; 1956 void TIM1_SetIC4Prescaler(TIM1_ICPSC_TypeDef TIM1_IC4Prescaler)
8089                     ; 1957 {
8090                     	switch	.text
8091  12f8               _TIM1_SetIC4Prescaler:
8093  12f8 88            	push	a
8094       00000000      OFST:	set	0
8097                     ; 1960     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC4Prescaler));
8099  12f9 4d            	tnz	a
...
8119  131b               L4031:
8120                     ; 1963     TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_ICxPSC)) |
8120                     ; 1964                             (uint8_t)TIM1_IC4Prescaler);
...
8536                     ; 2046     return (uint16_t)tmpccr4;
8538  13ba 1e03          	ldw	x,(OFST-1,sp)
8541  13bc 5b04          	addw	sp,#4
8542  13be 81            	ret
8576                     ; 2054 uint16_t TIM1_GetCounter(void)
8576                     ; 2055 {
8577                     	switch	.text
8578  13bf               _TIM1_GetCounter:
8580  13bf 89            	pushw	x
8581       00000002      OFST:	set	2
8584                     ; 2056   uint16_t tmpcntr = 0;
8586                     ; 2058   tmpcntr = ((uint16_t)TIM1->CNTRH << 8);
...
8595                     ; 2061     return (uint16_t)(tmpcntr | (uint16_t)(TIM1->CNTRL));
...
8608  13d7 81            	ret
8642                     ; 2069 uint16_t TIM1_GetPrescaler(void)
8642                     ; 2070 {
8643                     	switch	.text
8644  13d8               _TIM1_GetPrescaler:
8646  13d8 89            	pushw	x
8647       00000002      OFST:	set	2
8650                     ; 2071    uint16_t temp = 0;
8652                     ; 2073    temp = ((uint16_t)TIM1->PSCRH << 8);
...
8661                     ; 2076     return (uint16_t)( temp | (uint16_t)(TIM1->PSCRL));
...
8674  13f0 81            	ret
8849                     ; 2097 FlagStatus TIM1_GetFlagStatus(TIM1_FLAG_TypeDef TIM1_FLAG)
8849                     ; 2098 {
8850                     	switch	.text
...
8858                     ; 2099     FlagStatus bitstatus = RESET;
8860                     ; 2100     uint8_t tim1_flag_l = 0, tim1_flag_h = 0;
8864                     ; 2103     assert_param(IS_TIM1_GET_FLAG_OK(TIM1_FLAG));
...
9006  1485               L6331:
9007                     ; 2143     TIM1->SR1 = (uint8_t)(~(uint8_t)(TIM1_FLAG));
9009  1485 7b02          	ld	a,(OFST+2,sp)
9010  1487 43            	cpl	a
9011  1488 c75255        	ld	21077,a
9012                     ; 2144     TIM1->SR2 = (uint8_t)((uint8_t)(~((uint8_t)((uint16_t)TIM1_FLAG >> 8))) & 
9012                     ; 2145                           (uint8_t)0x1E);
...
9021  1493 85            	popw	x
9022  1494 81            	ret
9087                     ; 2162 ITStatus TIM1_GetITStatus(TIM1_IT_TypeDef TIM1_IT)
9087                     ; 2163 {
9088                     	switch	.text
...
9096                     ; 2164     ITStatus bitstatus = RESET;
9098                     ; 2165     uint8_t TIM1_itStatus = 0, TIM1_itEnable = 0;
9102                     ; 2168     assert_param(IS_TIM1_GET_IT_OK(TIM1_IT));
...
9231  1504               L4531:
9232                     ; 2205     TIM1->SR1 = (uint8_t)(~(uint8_t)TIM1_IT);
...
9240  150a 84            	pop	a
9241  150b 81            	ret
9293                     ; 2224 static void TI1_Config(uint8_t TIM1_ICPolarity,
9293                     ; 2225                        uint8_t TIM1_ICSelection,
9293                     ; 2226                        uint8_t TIM1_ICFilter)
9293                     ; 2227 {
9294                     	switch	.text
...
9302                     ; 2230     TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1E);
9304  150e 7211525c      	bres	21084,#0
9305                     ; 2233     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF ))) | 
9305                     ; 2234                             (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
9319                     ; 2237     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
9321  1527 0d02          	tnz	(OFST+1,sp)
9322  1529 2706          	jreq	L3163
9323                     ; 2239         TIM1->CCER1 |= TIM1_CCER1_CC1P;
9325  152b 7212525c      	bset	21084,#1
9327  152f 2004          	jra	L5163
9328  1531               L3163:
9329                     ; 2243         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
9331  1531 7213525c      	bres	21084,#1
9332  1535               L5163:
9333                     ; 2247     TIM1->CCER1 |=  TIM1_CCER1_CC1E;
9335  1535 7210525c      	bset	21084,#0
9336                     ; 2248 }
9339  1539 5b03          	addw	sp,#3
9340  153b 81            	ret
9392                     ; 2266 static void TI2_Config(uint8_t TIM1_ICPolarity,
9392                     ; 2267                        uint8_t TIM1_ICSelection,
9392                     ; 2268                        uint8_t TIM1_ICFilter)
9392                     ; 2269 {
9393                     	switch	.text
...
9401                     ; 2271     TIM1->CCER1 &=  (uint8_t)(~TIM1_CCER1_CC2E);
9403  153e 7219525c      	bres	21084,#4
9404                     ; 2274     TIM1->CCMR2  = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF ))) 
9404                     ; 2275                             | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
9418                     ; 2277     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
9420  1557 0d02          	tnz	(OFST+1,sp)
9421  1559 2706          	jreq	L5463
9422                     ; 2279         TIM1->CCER1 |= TIM1_CCER1_CC2P;
9424  155b 721a525c      	bset	21084,#5
9426  155f 2004          	jra	L7463
9427  1561               L5463:
9428                     ; 2283         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
9430  1561 721b525c      	bres	21084,#5
9431  1565               L7463:
9432                     ; 2286     TIM1->CCER1 |=  TIM1_CCER1_CC2E;
9434  1565 7218525c      	bset	21084,#4
9435                     ; 2287 }
9438  1569 5b03          	addw	sp,#3
9439  156b 81            	ret
9491                     ; 2305 static void TI3_Config(uint8_t TIM1_ICPolarity,
9491                     ; 2306                        uint8_t TIM1_ICSelection,
9491                     ; 2307                        uint8_t TIM1_ICFilter)
9491                     ; 2308 {
9492                     	switch	.text
...
9500                     ; 2310     TIM1->CCER2 &=  (uint8_t)(~TIM1_CCER2_CC3E);
9502  156e 7211525d      	bres	21085,#0
9503                     ; 2313     TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF))) 
9503                     ; 2314                             | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
9517                     ; 2317     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
9519  1587 0d02          	tnz	(OFST+1,sp)
9520  1589 2706          	jreq	L7763
9521                     ; 2319         TIM1->CCER2 |= TIM1_CCER2_CC3P;
9523  158b 7212525d      	bset	21085,#1
9525  158f 2004          	jra	L1073
9526  1591               L7763:
9527                     ; 2323         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3P);
9529  1591 7213525d      	bres	21085,#1
9530  1595               L1073:
9531                     ; 2326     TIM1->CCER2 |=  TIM1_CCER2_CC3E;
9533  1595 7210525d      	bset	21085,#0
9534                     ; 2327 }
9537  1599 5b03          	addw	sp,#3
9538  159b 81            	ret
9590                     ; 2346 static void TI4_Config(uint8_t TIM1_ICPolarity,
9590                     ; 2347                        uint8_t TIM1_ICSelection,
9590                     ; 2348                        uint8_t TIM1_ICFilter)
9590                     ; 2349 {
9591                     	switch	.text
...
9599                     ; 2352     TIM1->CCER2 &=  (uint8_t)(~TIM1_CCER2_CC4E);
9601  159e 7219525d      	bres	21085,#4
9602                     ; 2355     TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF )))
9602                     ; 2356                             | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
9616                     ; 2359     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
9618  15b7 0d02          	tnz	(OFST+1,sp)
9619  15b9 2706          	jreq	L1373
9620                     ; 2361         TIM1->CCER2 |= TIM1_CCER2_CC4P;
9622  15bb 721a525d      	bset	21085,#5
9624  15bf 2004          	jra	L3373
9625  15c1               L1373:
9626                     ; 2365         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4P);
9628  15c1 721b525d      	bres	21085,#5
9629  15c5               L3373:
9630                     ; 2369     TIM1->CCER2 |=  TIM1_CCER2_CC4E;
...
9726  0000               L101:
9727  0000 7374645f6c69  	dc.b	"std_lib\src\stm8s_"
9728  0012 74696d312e63  	dc.b	"tim1.c",0
9748                     	end
