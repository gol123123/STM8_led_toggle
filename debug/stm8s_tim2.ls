 ...
 508  009b               L61:
 509                     ; 111     assert_param(IS_TIM2_OUTPUT_STATE_OK(TIM2_OutputState));
 ...
 528  00b8               L42:
 529                     ; 112     assert_param(IS_TIM2_OC_POLARITY_OK(TIM2_OCPolarity));
 ...
 548  00d5               L23:
 549                     ; 115     TIM2->CCER1 &= (uint8_t)(~( TIM2_CCER1_CC1E | TIM2_CCER1_CC1P));
 551  00d5 c6530a        	ld	a,21258
 552  00d8 a4fc          	and	a,#252
 553  00da c7530a        	ld	21258,a
 554                     ; 117     TIM2->CCER1 |= (uint8_t)((uint8_t)(TIM2_OutputState & TIM2_CCER1_CC1E ) | 
 554                     ; 118                              (uint8_t)(TIM2_OCPolarity & TIM2_CCER1_CC1P));
...
1539  03c1               L164:
1540                     ; 287         icpolarity = (uint8_t)TIM2_ICPOLARITY_RISING;
1542  03c1 0f01          	clr	(OFST-1,sp)
1544  03c3               L364:
1545                     ; 291     if (TIM2_ICSelection == TIM2_ICSELECTION_DIRECTTI)
1547  03c3 7b07          	ld	a,(OFST+5,sp)
1548  03c5 a101          	cp	a,#1
1549  03c7 2606          	jrne	L564
1550                     ; 293         icselection = (uint8_t)TIM2_ICSELECTION_INDIRECTTI;
1552  03c9 a602          	ld	a,#2
1553  03cb 6b02          	ld	(OFST+0,sp),a
1556  03cd 2004          	jra	L764
1557  03cf               L564:
1558                     ; 297         icselection = (uint8_t)TIM2_ICSELECTION_DIRECTTI;
1560  03cf a601          	ld	a,#1
1561  03d1 6b02          	ld	(OFST+0,sp),a
1563  03d3               L764:
1564                     ; 300     if (TIM2_Channel == TIM2_CHANNEL_1)
1566  03d3 0d03          	tnz	(OFST+1,sp)
1567  03d5 2626          	jrne	L174
1568                     ; 303         TI1_Config((uint8_t)TIM2_ICPolarity, (uint8_t)TIM2_ICSelection,
1568                     ; 304                    (uint8_t)TIM2_ICFilter);
...
1578  03e3 84            	pop	a
1579                     ; 307         TIM2_SetIC1Prescaler(TIM2_ICPrescaler);
1581  03e4 7b08          	ld	a,(OFST+6,sp)
1582  03e6 cd08c3        	call	_TIM2_SetIC1Prescaler
1584                     ; 310         TI2_Config(icpolarity, icselection, TIM2_ICFilter);
...
1594  03f5 84            	pop	a
1595                     ; 313         TIM2_SetIC2Prescaler(TIM2_ICPrescaler);
1597  03f6 7b08          	ld	a,(OFST+6,sp)
1598  03f8 cd08f2        	call	_TIM2_SetIC2Prescaler
1601  03fb 2024          	jra	L374
1602  03fd               L174:
1603                     ; 318         TI2_Config((uint8_t)TIM2_ICPolarity, (uint8_t)TIM2_ICSelection,
1603                     ; 319                    (uint8_t)TIM2_ICFilter);
...
1613  0409 84            	pop	a
1614                     ; 322         TIM2_SetIC2Prescaler(TIM2_ICPrescaler);
1616  040a 7b08          	ld	a,(OFST+6,sp)
1617  040c cd08f2        	call	_TIM2_SetIC2Prescaler
1619                     ; 325         TI1_Config((uint8_t)icpolarity, icselection, (uint8_t)TIM2_ICFilter);
...
1629  041b 84            	pop	a
1630                     ; 328         TIM2_SetIC1Prescaler(TIM2_ICPrescaler);
...
1740  044d 84            	pop	a
1741  044e 81            	ret
1821                     ; 369 void TIM2_ITConfig(TIM2_IT_TypeDef TIM2_IT, FunctionalState NewState)
1821                     ; 370 {
1822                     	switch	.text
1823  044f               _TIM2_ITConfig:
1825  044f 89            	pushw	x
1826       00000000      OFST:	set	0
1829                     ; 372     assert_param(IS_TIM2_IT_OK(TIM2_IT));
...
1848  046c               L012:
1849                     ; 373     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
1891  04a0 85            	popw	x
1892  04a1 81            	ret
1929                     ; 394 void TIM2_UpdateDisableConfig(FunctionalState NewState)
1929                     ; 395 {
1930                     	switch	.text
1931  04a2               _TIM2_UpdateDisableConfig:
1933  04a2 88            	push	a
1934       00000000      OFST:	set	0
1937                     ; 397     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1939  04a3 4d            	tnz	a
...
1955  04bd               L622:
1956                     ; 400     if (NewState != DISABLE)
1958  04bd 0d01          	tnz	(OFST+1,sp)
1959  04bf 2706          	jreq	L706
1960                     ; 402         TIM2->CR1 |= (uint8_t)TIM2_CR1_UDIS;
1962  04c1 72125300      	bset	21248,#1
1964  04c5 2004          	jra	L116
1965  04c7               L706:
1966                     ; 406         TIM2->CR1 &= (uint8_t)(~TIM2_CR1_UDIS);
1968  04c7 72135300      	bres	21248,#1
1969  04cb               L116:
1970                     ; 408 }
1973  04cb 84            	pop	a
1974  04cc 81            	ret
2033                     ; 418 void TIM2_UpdateRequestConfig(TIM2_UpdateSource_TypeDef TIM2_UpdateSource)
2033                     ; 419 {
2034                     	switch	.text
2035  04cd               _TIM2_UpdateRequestConfig:
2037  04cd 88            	push	a
2038       00000000      OFST:	set	0
2041                     ; 421     assert_param(IS_TIM2_UPDATE_SOURCE_OK(TIM2_UpdateSource));
2043  04ce 4d            	tnz	a
...
2059  04e8               L632:
2060                     ; 424     if (TIM2_UpdateSource != TIM2_UPDATESOURCE_GLOBAL)
2062  04e8 0d01          	tnz	(OFST+1,sp)
2063  04ea 2706          	jreq	L146
2064                     ; 426         TIM2->CR1 |= (uint8_t)TIM2_CR1_URS;
2066  04ec 72145300      	bset	21248,#2
2068  04f0 2004          	jra	L346
2069  04f2               L146:
2070                     ; 430         TIM2->CR1 &= (uint8_t)(~TIM2_CR1_URS);
2072  04f2 72155300      	bres	21248,#2
2073  04f6               L346:
2074                     ; 432 }
2077  04f6 84            	pop	a
2078  04f7 81            	ret
2136                     ; 443 void TIM2_SelectOnePulseMode(TIM2_OPMode_TypeDef TIM2_OPMode)
2136                     ; 444 {
2137                     	switch	.text
2138  04f8               _TIM2_SelectOnePulseMode:
2140  04f8 88            	push	a
2141       00000000      OFST:	set	0
2144                     ; 446     assert_param(IS_TIM2_OPM_MODE_OK(TIM2_OPMode));
...
2162  0513               L642:
2163                     ; 449     if (TIM2_OPMode != TIM2_OPMODE_REPETITIVE)
2165  0513 0d01          	tnz	(OFST+1,sp)
2166  0515 2706          	jreq	L376
2167                     ; 451         TIM2->CR1 |= (uint8_t)TIM2_CR1_OPM;
2169  0517 72165300      	bset	21248,#3
2171  051b 2004          	jra	L576
2172  051d               L376:
2173                     ; 455         TIM2->CR1 &= (uint8_t)(~TIM2_CR1_OPM);
2175  051d 72175300      	bres	21248,#3
2176  0521               L576:
2177                     ; 458 }
2180  0521 84            	pop	a
2181  0522 81            	ret
2250                     ; 489 void TIM2_PrescalerConfig(TIM2_Prescaler_TypeDef Prescaler,
2250                     ; 490                           TIM2_PSCReloadMode_TypeDef TIM2_PSCReloadMode)
2250                     ; 491 {
2251                     	switch	.text
2252  0523               _TIM2_PrescalerConfig:
2254  0523 89            	pushw	x
2255       00000000      OFST:	set	0
2258                     ; 493     assert_param(IS_TIM2_PRESCALER_RELOAD_OK(TIM2_PSCReloadMode));
...
2278  0540               L652:
2279                     ; 494     assert_param(IS_TIM2_PRESCALER_OK(Prescaler));
...
2340  05b1               L462:
2341                     ; 497     TIM2->PSCR = (uint8_t)Prescaler;
2343  05b1 7b01          	ld	a,(OFST+1,sp)
2344  05b3 c7530e        	ld	21262,a
2345                     ; 500     TIM2->EGR = (uint8_t)TIM2_PSCReloadMode;
2347  05b6 7b02          	ld	a,(OFST+2,sp)
2348  05b8 c75306        	ld	21254,a
2349                     ; 501 }
2352  05bb 85            	popw	x
2353  05bc 81            	ret
2412                     ; 512 void TIM2_ForcedOC1Config(TIM2_ForcedAction_TypeDef TIM2_ForcedAction)
2412                     ; 513 {
2413                     	switch	.text
2414  05bd               _TIM2_ForcedOC1Config:
2416  05bd 88            	push	a
2417       00000000      OFST:	set	0
2420                     ; 515     assert_param(IS_TIM2_FORCED_ACTION_OK(TIM2_ForcedAction));
...
2438  05d9               L472:
2439                     ; 518     TIM2->CCMR1  =  (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~TIM2_CCMR_OCM))  
2439                     ; 519                               | (uint8_t)TIM2_ForcedAction);
...
2448  05e3 84            	pop	a
2449  05e4 81            	ret
2486                     ; 531 void TIM2_ForcedOC2Config(TIM2_ForcedAction_TypeDef TIM2_ForcedAction)
2486                     ; 532 {
2487                     	switch	.text
2488  05e5               _TIM2_ForcedOC2Config:
2490  05e5 88            	push	a
2491       00000000      OFST:	set	0
2494                     ; 534     assert_param(IS_TIM2_FORCED_ACTION_OK(TIM2_ForcedAction));
...
2512  0601               L403:
2513                     ; 537     TIM2->CCMR2 = (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~TIM2_CCMR_OCM))  
2513                     ; 538                             | (uint8_t)TIM2_ForcedAction);
...
2522  060b 84            	pop	a
2523  060c 81            	ret
2560                     ; 550 void TIM2_ForcedOC3Config(TIM2_ForcedAction_TypeDef TIM2_ForcedAction)
2560                     ; 551 {
2561                     	switch	.text
2562  060d               _TIM2_ForcedOC3Config:
2564  060d 88            	push	a
2565       00000000      OFST:	set	0
2568                     ; 553     assert_param(IS_TIM2_FORCED_ACTION_OK(TIM2_ForcedAction));
...
2586  0629               L413:
2587                     ; 556     TIM2->CCMR3  =  (uint8_t)((uint8_t)(TIM2->CCMR3 & (uint8_t)(~TIM2_CCMR_OCM))
2587                     ; 557                               | (uint8_t)TIM2_ForcedAction);
...
2596  0633 84            	pop	a
2597  0634 81            	ret
2634                     ; 567 void TIM2_ARRPreloadConfig(FunctionalState NewState)
2634                     ; 568 {
2635                     	switch	.text
2636  0635               _TIM2_ARRPreloadConfig:
2638  0635 88            	push	a
2639       00000000      OFST:	set	0
2642                     ; 570     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2644  0636 4d            	tnz	a
...
2660  0650               L423:
2661                     ; 573     if (NewState != DISABLE)
2663  0650 0d01          	tnz	(OFST+1,sp)
2664  0652 2706          	jreq	L1301
2665                     ; 575         TIM2->CR1 |= (uint8_t)TIM2_CR1_ARPE;
2667  0654 721e5300      	bset	21248,#7
2669  0658 2004          	jra	L3301
2670  065a               L1301:
2671                     ; 579         TIM2->CR1 &= (uint8_t)(~TIM2_CR1_ARPE);
2673  065a 721f5300      	bres	21248,#7
2674  065e               L3301:
2675                     ; 581 }
2678  065e 84            	pop	a
2679  065f 81            	ret
2716                     ; 590 void TIM2_OC1PreloadConfig(FunctionalState NewState)
2716                     ; 591 {
2717                     	switch	.text
2718  0660               _TIM2_OC1PreloadConfig:
2720  0660 88            	push	a
2721       00000000      OFST:	set	0
2724                     ; 593     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2726  0661 4d            	tnz	a
...
2742  067b               L433:
2743                     ; 596     if (NewState != DISABLE)
2745  067b 0d01          	tnz	(OFST+1,sp)
2746  067d 2706          	jreq	L3501
2747                     ; 598         TIM2->CCMR1 |= (uint8_t)TIM2_CCMR_OCxPE;
2749  067f 72165307      	bset	21255,#3
2751  0683 2004          	jra	L5501
2752  0685               L3501:
2753                     ; 602         TIM2->CCMR1 &= (uint8_t)(~TIM2_CCMR_OCxPE);
2755  0685 72175307      	bres	21255,#3
2756  0689               L5501:
2757                     ; 604 }
2760  0689 84            	pop	a
2761  068a 81            	ret
2798                     ; 613 void TIM2_OC2PreloadConfig(FunctionalState NewState)
2798                     ; 614 {
2799                     	switch	.text
2800  068b               _TIM2_OC2PreloadConfig:
2802  068b 88            	push	a
2803       00000000      OFST:	set	0
2806                     ; 616     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2808  068c 4d            	tnz	a
...
2824  06a6               L443:
2825                     ; 619     if (NewState != DISABLE)
2827  06a6 0d01          	tnz	(OFST+1,sp)
2828  06a8 2706          	jreq	L5701
2829                     ; 621         TIM2->CCMR2 |= (uint8_t)TIM2_CCMR_OCxPE;
2831  06aa 72165308      	bset	21256,#3
2833  06ae 2004          	jra	L7701
2834  06b0               L5701:
2835                     ; 625         TIM2->CCMR2 &= (uint8_t)(~TIM2_CCMR_OCxPE);
2837  06b0 72175308      	bres	21256,#3
2838  06b4               L7701:
2839                     ; 627 }
2842  06b4 84            	pop	a
2843  06b5 81            	ret
2880                     ; 636 void TIM2_OC3PreloadConfig(FunctionalState NewState)
2880                     ; 637 {
2881                     	switch	.text
2882  06b6               _TIM2_OC3PreloadConfig:
2884  06b6 88            	push	a
2885       00000000      OFST:	set	0
2888                     ; 639     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2890  06b7 4d            	tnz	a
...
2906  06d1               L453:
2907                     ; 642     if (NewState != DISABLE)
2909  06d1 0d01          	tnz	(OFST+1,sp)
2910  06d3 2706          	jreq	L7111
2911                     ; 644         TIM2->CCMR3 |= (uint8_t)TIM2_CCMR_OCxPE;
2913  06d5 72165309      	bset	21257,#3
2915  06d9 2004          	jra	L1211
2916  06db               L7111:
2917                     ; 648         TIM2->CCMR3 &= (uint8_t)(~TIM2_CCMR_OCxPE);
2919  06db 72175309      	bres	21257,#3
2920  06df               L1211:
2921                     ; 650 }
2924  06df 84            	pop	a
2925  06e0 81            	ret
2999                     ; 663 void TIM2_GenerateEvent(TIM2_EventSource_TypeDef TIM2_EventSource)
2999                     ; 664 {
3000                     	switch	.text
3001  06e1               _TIM2_GenerateEvent:
3003  06e1 88            	push	a
3004       00000000      OFST:	set	0
3007                     ; 666     assert_param(IS_TIM2_EVENT_SOURCE_OK(TIM2_EventSource));
3009  06e2 4d            	tnz	a
3010  06e3 2703          	jreq	L063
3011  06e5 4f            	clr	a
3012  06e6 2010          	jra	L263
3013  06e8               L063:
3014  06e8 ae029a        	ldw	x,#666
...
3022  06f8               L263:
3023                     ; 669     TIM2->EGR = (uint8_t)TIM2_EventSource;
3025  06f8 7b01          	ld	a,(OFST+1,sp)
3026  06fa c75306        	ld	21254,a
3027                     ; 670 }
3030  06fd 84            	pop	a
3031  06fe 81            	ret
3068                     ; 681 void TIM2_OC1PolarityConfig(TIM2_OCPolarity_TypeDef TIM2_OCPolarity)
3068                     ; 682 {
3069                     	switch	.text
3070  06ff               _TIM2_OC1PolarityConfig:
3072  06ff 88            	push	a
3073       00000000      OFST:	set	0
3076                     ; 684     assert_param(IS_TIM2_OC_POLARITY_OK(TIM2_OCPolarity));
3078  0700 4d            	tnz	a
...
3094  071a               L273:
3095                     ; 687     if (TIM2_OCPolarity != TIM2_OCPOLARITY_HIGH)
3097  071a 0d01          	tnz	(OFST+1,sp)
3098  071c 2706          	jreq	L3711
3099                     ; 689         TIM2->CCER1 |= (uint8_t)TIM2_CCER1_CC1P;
3101  071e 7212530a      	bset	21258,#1
3103  0722 2004          	jra	L5711
3104  0724               L3711:
3105                     ; 693         TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1P);
3107  0724 7213530a      	bres	21258,#1
3108  0728               L5711:
3109                     ; 695 }
3112  0728 84            	pop	a
3113  0729 81            	ret
3150                     ; 706 void TIM2_OC2PolarityConfig(TIM2_OCPolarity_TypeDef TIM2_OCPolarity)
3150                     ; 707 {
3151                     	switch	.text
3152  072a               _TIM2_OC2PolarityConfig:
3154  072a 88            	push	a
3155       00000000      OFST:	set	0
3158                     ; 709     assert_param(IS_TIM2_OC_POLARITY_OK(TIM2_OCPolarity));
3160  072b 4d            	tnz	a
...
3176  0745               L204:
3177                     ; 712     if (TIM2_OCPolarity != TIM2_OCPOLARITY_HIGH)
3179  0745 0d01          	tnz	(OFST+1,sp)
3180  0747 2706          	jreq	L5121
3181                     ; 714         TIM2->CCER1 |= TIM2_CCER1_CC2P;
3183  0749 721a530a      	bset	21258,#5
3185  074d 2004          	jra	L7121
3186  074f               L5121:
3187                     ; 718         TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2P);
3189  074f 721b530a      	bres	21258,#5
3190  0753               L7121:
3191                     ; 720 }
3194  0753 84            	pop	a
3195  0754 81            	ret
3232                     ; 731 void TIM2_OC3PolarityConfig(TIM2_OCPolarity_TypeDef TIM2_OCPolarity)
3232                     ; 732 {
3233                     	switch	.text
3234  0755               _TIM2_OC3PolarityConfig:
3236  0755 88            	push	a
3237       00000000      OFST:	set	0
3240                     ; 734     assert_param(IS_TIM2_OC_POLARITY_OK(TIM2_OCPolarity));
3242  0756 4d            	tnz	a
...
3258  0770               L214:
3259                     ; 737     if (TIM2_OCPolarity != TIM2_OCPOLARITY_HIGH)
3261  0770 0d01          	tnz	(OFST+1,sp)
3262  0772 2706          	jreq	L7321
3263                     ; 739         TIM2->CCER2 |= (uint8_t)TIM2_CCER2_CC3P;
3265  0774 7212530b      	bset	21259,#1
3267  0778 2004          	jra	L1421
3268  077a               L7321:
3269                     ; 743         TIM2->CCER2 &= (uint8_t)(~TIM2_CCER2_CC3P);
3271  077a 7213530b      	bres	21259,#1
3272  077e               L1421:
3273                     ; 745 }
3276  077e 84            	pop	a
3277  077f 81            	ret
3323                     ; 759 void TIM2_CCxCmd(TIM2_Channel_TypeDef TIM2_Channel, FunctionalState NewState)
3323                     ; 760 {
3324                     	switch	.text
3325  0780               _TIM2_CCxCmd:
3327  0780 89            	pushw	x
3328       00000000      OFST:	set	0
3331                     ; 762     assert_param(IS_TIM2_CHANNEL_OK(TIM2_Channel));
...
3354  07a2               L224:
3355                     ; 763     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
3509  081b               L044:
3510                     ; 828     assert_param(IS_TIM2_OCM_OK(TIM2_OCMode));
...
3547  085c               L644:
3548                     ; 830     if (TIM2_Channel == TIM2_CHANNEL_1)
3550  085c 0d01          	tnz	(OFST+1,sp)
3551  085e 2610          	jrne	L3331
3552                     ; 833         TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1E);
3554  0860 7211530a      	bres	21258,#0
3555                     ; 836         TIM2->CCMR1 = (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~TIM2_CCMR_OCM))
3555                     ; 837                                | (uint8_t)TIM2_OCMode);
...
3563  0870               L3331:
3564                     ; 839     else if (TIM2_Channel == TIM2_CHANNEL_2)
3566  0870 7b01          	ld	a,(OFST+1,sp)
3567  0872 a101          	cp	a,#1
3568  0874 2610          	jrne	L7331
3569                     ; 842         TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2E);
3571  0876 7219530a      	bres	21258,#4
3572                     ; 845         TIM2->CCMR2 = (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~TIM2_CCMR_OCM))
3572                     ; 846                                 | (uint8_t)TIM2_OCMode);
...
3580  0886               L7331:
3581                     ; 851         TIM2->CCER2 &= (uint8_t)(~TIM2_CCER2_CC3E);
3583  0886 7211530b      	bres	21259,#0
3584                     ; 854         TIM2->CCMR3 = (uint8_t)((uint8_t)(TIM2->CCMR3 & (uint8_t)(~TIM2_CCMR_OCM))
3584                     ; 855                                 | (uint8_t)TIM2_OCMode);
...
3594  0894 85            	popw	x
3595  0895 81            	ret
3629                     ; 866 void TIM2_SetCounter(uint16_t Counter)
3629                     ; 867 {
3630                     	switch	.text
3631  0896               _TIM2_SetCounter:
3635                     ; 869     TIM2->CNTRH = (uint8_t)(Counter >> 8);
3637  0896 9e            	ld	a,xh
3638  0897 c7530c        	ld	21260,a
3639                     ; 870     TIM2->CNTRL = (uint8_t)(Counter);
3641  089a 9f            	ld	a,xl
3642  089b c7530d        	ld	21261,a
3643                     ; 872 }
3646  089e 81            	ret
3680                     ; 881 void TIM2_SetAutoreload(uint16_t Autoreload)
3680                     ; 882 {
3681                     	switch	.text
3682  089f               _TIM2_SetAutoreload:
3686                     ; 885     TIM2->ARRH = (uint8_t)(Autoreload >> 8);
3688  089f 9e            	ld	a,xh
3689  08a0 c7530f        	ld	21263,a
3690                     ; 886     TIM2->ARRL = (uint8_t)(Autoreload);
3692  08a3 9f            	ld	a,xl
3693  08a4 c75310        	ld	21264,a
3694                     ; 888 }
3697  08a7 81            	ret
3731                     ; 897 void TIM2_SetCompare1(uint16_t Compare1)
3731                     ; 898 {
3732                     	switch	.text
3733  08a8               _TIM2_SetCompare1:
3737                     ; 900     TIM2->CCR1H = (uint8_t)(Compare1 >> 8);
3739  08a8 9e            	ld	a,xh
3740  08a9 c75311        	ld	21265,a
3741                     ; 901     TIM2->CCR1L = (uint8_t)(Compare1);
3743  08ac 9f            	ld	a,xl
3744  08ad c75312        	ld	21266,a
3745                     ; 903 }
3748  08b0 81            	ret
3782                     ; 912 void TIM2_SetCompare2(uint16_t Compare2)
3782                     ; 913 {
3783                     	switch	.text
3784  08b1               _TIM2_SetCompare2:
3788                     ; 915     TIM2->CCR2H = (uint8_t)(Compare2 >> 8);
3790  08b1 9e            	ld	a,xh
3791  08b2 c75313        	ld	21267,a
3792                     ; 916     TIM2->CCR2L = (uint8_t)(Compare2);
3794  08b5 9f            	ld	a,xl
3795  08b6 c75314        	ld	21268,a
3796                     ; 918 }
3799  08b9 81            	ret
3833                     ; 927 void TIM2_SetCompare3(uint16_t Compare3)
3833                     ; 928 {
3834                     	switch	.text
3835  08ba               _TIM2_SetCompare3:
3839                     ; 930     TIM2->CCR3H = (uint8_t)(Compare3 >> 8);
3841  08ba 9e            	ld	a,xh
3842  08bb c75315        	ld	21269,a
3843                     ; 931     TIM2->CCR3L = (uint8_t)(Compare3);
3845  08be 9f            	ld	a,xl
3846  08bf c75316        	ld	21270,a
3847                     ; 933 }
3850  08c2 81            	ret
3887                     ; 946 void TIM2_SetIC1Prescaler(TIM2_ICPSC_TypeDef TIM2_IC1Prescaler)
3887                     ; 947 {
3888                     	switch	.text
3889  08c3               _TIM2_SetIC1Prescaler:
3891  08c3 88            	push	a
3892       00000000      OFST:	set	0
3895                     ; 949     assert_param(IS_TIM2_IC_PRESCALER_OK(TIM2_IC1Prescaler));
3897  08c4 4d            	tnz	a
...
3917  08e6               L074:
3918                     ; 952     TIM2->CCMR1 = (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~TIM2_CCMR_ICxPSC))
3918                     ; 953                             | (uint8_t)TIM2_IC1Prescaler);
...
3927  08f0 84            	pop	a
3928  08f1 81            	ret
3965                     ; 966 void TIM2_SetIC2Prescaler(TIM2_ICPSC_TypeDef TIM2_IC2Prescaler)
3965                     ; 967 {
3966                     	switch	.text
3967  08f2               _TIM2_SetIC2Prescaler:
3969  08f2 88            	push	a
3970       00000000      OFST:	set	0
3973                     ; 969     assert_param(IS_TIM2_IC_PRESCALER_OK(TIM2_IC2Prescaler));
3975  08f3 4d            	tnz	a
...
3995  0915               L005:
3996                     ; 972     TIM2->CCMR2 = (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~TIM2_CCMR_ICxPSC))
3996                     ; 973                             | (uint8_t)TIM2_IC2Prescaler);
...
4005  091f 84            	pop	a
4006  0920 81            	ret
4043                     ; 986 void TIM2_SetIC3Prescaler(TIM2_ICPSC_TypeDef TIM2_IC3Prescaler)
4043                     ; 987 {
4044                     	switch	.text
4045  0921               _TIM2_SetIC3Prescaler:
4047  0921 88            	push	a
4048       00000000      OFST:	set	0
4051                     ; 990     assert_param(IS_TIM2_IC_PRESCALER_OK(TIM2_IC3Prescaler));
4053  0922 4d            	tnz	a
...
4073  0944               L015:
4074                     ; 992     TIM2->CCMR3 = (uint8_t)((uint8_t)(TIM2->CCMR3 & (uint8_t)(~TIM2_CCMR_ICxPSC))
4074                     ; 993                             | (uint8_t)TIM2_IC3Prescaler);
...
4387                     ; 1053     return (uint16_t)tmpccr3;
4389  09bd 1e03          	ldw	x,(OFST-1,sp)
4392  09bf 5b04          	addw	sp,#4
4393  09c1 81            	ret
4427                     ; 1061 uint16_t TIM2_GetCounter(void)
4427                     ; 1062 {
4428                     	switch	.text
4429  09c2               _TIM2_GetCounter:
4431  09c2 89            	pushw	x
4432       00000002      OFST:	set	2
4435                     ; 1063      uint16_t tmpcntr = 0;
4437                     ; 1065     tmpcntr =  ((uint16_t)TIM2->CNTRH << 8);
...
4446                     ; 1067     return (uint16_t)( tmpcntr| (uint16_t)(TIM2->CNTRL));
...
4459  09da 81            	ret
4483                     ; 1076 TIM2_Prescaler_TypeDef TIM2_GetPrescaler(void)
4483                     ; 1077 {
4484                     	switch	.text
4485  09db               _TIM2_GetPrescaler:
4489                     ; 1079     return (TIM2_Prescaler_TypeDef)(TIM2->PSCR);
4491  09db c6530e        	ld	a,21262
4494  09de 81            	ret
4634                     ; 1096 FlagStatus TIM2_GetFlagStatus(TIM2_FLAG_TypeDef TIM2_FLAG)
4634                     ; 1097 {
4635                     	switch	.text
...
4643                     ; 1098     FlagStatus bitstatus = RESET;
4645                     ; 1099     uint8_t tim2_flag_l = 0, tim2_flag_h = 0;
4649                     ; 1102     assert_param(IS_TIM2_GET_FLAG_OK(TIM2_FLAG));
...
4707  0a33               L1471:
4708                     ; 1115     return (FlagStatus)bitstatus;
4710  0a33 7b02          	ld	a,(OFST+0,sp)
4713  0a35 5b04          	addw	sp,#4
4714  0a37 81            	ret
4750                     ; 1132 void TIM2_ClearFlag(TIM2_FLAG_TypeDef TIM2_FLAG)
4750                     ; 1133 {
4751                     	switch	.text
4752  0a38               _TIM2_ClearFlag:
4754  0a38 89            	pushw	x
4755       00000000      OFST:	set	0
4758                     ; 1135     assert_param(IS_TIM2_CLEAR_FLAG_OK(TIM2_FLAG));
...
4780  0a5c               L045:
4781                     ; 1138     TIM2->SR1 = (uint8_t)(~((uint8_t)(TIM2_FLAG)));
4783  0a5c 7b02          	ld	a,(OFST+2,sp)
4784  0a5e 43            	cpl	a
4785  0a5f c75304        	ld	21252,a
4786                     ; 1139     TIM2->SR2 = (uint8_t)(~((uint8_t)((uint8_t)TIM2_FLAG >> 8)));
4788  0a62 35ff5305      	mov	21253,#255
4789                     ; 1140 }
4792  0a66 85            	popw	x
4793  0a67 81            	ret
4858                     ; 1154 ITStatus TIM2_GetITStatus(TIM2_IT_TypeDef TIM2_IT)
4858                     ; 1155 {
4859                     	switch	.text
...
4867                     ; 1156     ITStatus bitstatus = RESET;
4869                     ; 1157     uint8_t TIM2_itStatus = 0, TIM2_itEnable = 0;
4873                     ; 1160     assert_param(IS_TIM2_GET_IT_OK(TIM2_IT));
...
4996  0acb               L655:
4997                     ; 1194     TIM2->SR1 = (uint8_t)(~TIM2_IT);
...
5005  0ad1 84            	pop	a
5006  0ad2 81            	ret
5058                     ; 1214 static void TI1_Config(uint8_t TIM2_ICPolarity,
5058                     ; 1215                        uint8_t TIM2_ICSelection,
5058                     ; 1216                        uint8_t TIM2_ICFilter)
5058                     ; 1217 {
5059                     	switch	.text
...
5067                     ; 1219     TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1E);
5069  0ad5 7211530a      	bres	21258,#0
5070                     ; 1222     TIM2->CCMR1  = (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~(uint8_t)( TIM2_CCMR_CCxS | TIM2_CCMR_ICxF )))
5070                     ; 1223                              | (uint8_t)(((TIM2_ICSelection)) | ((uint8_t)( TIM2_ICFilter << 4))));
...
5084                     ; 1226     if (TIM2_ICPolarity != TIM2_ICPOLARITY_RISING)
5086  0aee 0d02          	tnz	(OFST+1,sp)
5087  0af0 2706          	jreq	L3602
5088                     ; 1228         TIM2->CCER1 |= TIM2_CCER1_CC1P;
5090  0af2 7212530a      	bset	21258,#1
5092  0af6 2004          	jra	L5602
5093  0af8               L3602:
5094                     ; 1232         TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1P);
5096  0af8 7213530a      	bres	21258,#1
5097  0afc               L5602:
5098                     ; 1235     TIM2->CCER1 |= TIM2_CCER1_CC1E;
5100  0afc 7210530a      	bset	21258,#0
5101                     ; 1236 }
5104  0b00 5b03          	addw	sp,#3
5105  0b02 81            	ret
5157                     ; 1255 static void TI2_Config(uint8_t TIM2_ICPolarity,
5157                     ; 1256                        uint8_t TIM2_ICSelection,
5157                     ; 1257                        uint8_t TIM2_ICFilter)
5157                     ; 1258 {
5158                     	switch	.text
...
5166                     ; 1260     TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2E);
5168  0b05 7219530a      	bres	21258,#4
5169                     ; 1263     TIM2->CCMR2 = (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~(uint8_t)( TIM2_CCMR_CCxS | TIM2_CCMR_ICxF ))) 
5169                     ; 1264                             | (uint8_t)(( (TIM2_ICSelection)) | ((uint8_t)( TIM2_ICFilter << 4))));
...
5183                     ; 1268     if (TIM2_ICPolarity != TIM2_ICPOLARITY_RISING)
5185  0b1e 0d02          	tnz	(OFST+1,sp)
5186  0b20 2706          	jreq	L5112
5187                     ; 1270         TIM2->CCER1 |= TIM2_CCER1_CC2P;
5189  0b22 721a530a      	bset	21258,#5
5191  0b26 2004          	jra	L7112
5192  0b28               L5112:
5193                     ; 1274         TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2P);
5195  0b28 721b530a      	bres	21258,#5
5196  0b2c               L7112:
5197                     ; 1278     TIM2->CCER1 |= TIM2_CCER1_CC2E;
5199  0b2c 7218530a      	bset	21258,#4
5200                     ; 1280 }
5203  0b30 5b03          	addw	sp,#3
5204  0b32 81            	ret
5256                     ; 1296 static void TI3_Config(uint8_t TIM2_ICPolarity, uint8_t TIM2_ICSelection,
5256                     ; 1297                        uint8_t TIM2_ICFilter)
5256                     ; 1298 {
5257                     	switch	.text
...
5265                     ; 1300     TIM2->CCER2 &=  (uint8_t)(~TIM2_CCER2_CC3E);
5267  0b35 7211530b      	bres	21259,#0
5268                     ; 1303     TIM2->CCMR3 = (uint8_t)((uint8_t)(TIM2->CCMR3 & (uint8_t)(~( TIM2_CCMR_CCxS | TIM2_CCMR_ICxF))) 
5268                     ; 1304                             | (uint8_t)(( (TIM2_ICSelection)) | ((uint8_t)( TIM2_ICFilter << 4))));
...
5282                     ; 1308     if (TIM2_ICPolarity != TIM2_ICPOLARITY_RISING)
5284  0b4e 0d02          	tnz	(OFST+1,sp)
5285  0b50 2706          	jreq	L7412
5286                     ; 1310         TIM2->CCER2 |= TIM2_CCER2_CC3P;
5288  0b52 7212530b      	bset	21259,#1
5290  0b56 2004          	jra	L1512
5291  0b58               L7412:
5292                     ; 1314         TIM2->CCER2 &= (uint8_t)(~TIM2_CCER2_CC3P);
5294  0b58 7213530b      	bres	21259,#1
5295  0b5c               L1512:
5296                     ; 1317     TIM2->CCER2 |= TIM2_CCER2_CC3E;
...
5361  0000               L702:
5362  0000 7374645f6c69  	dc.b	"std_lib\src\stm8s_"
5363  0012 74696d322e63  	dc.b	"tim2.c",0
5383                     	end
