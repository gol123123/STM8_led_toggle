  ...
  88  0019               L01:
  89                     ; 52     WWDG->WR = WWDG_WR_RESET_VALUE;
  91  0019 357f50d2      	mov	20690,#127
  92                     ; 53     WWDG->CR = (uint8_t)((uint8_t)(WWDG_CR_WDGA | WWDG_CR_T6) | (uint8_t)Counter);
  94  001d 7b01          	ld	a,(OFST+1,sp)
  95  001f aac0          	or	a,#192
  96  0021 c750d1        	ld	20689,a
  97                     ; 54     WWDG->WR = (uint8_t)((uint8_t)(~WWDG_CR_WDGA) & (uint8_t)(WWDG_CR_T6 | WindowValue));
 ...
 106  002d 85            	popw	x
 107  002e 81            	ret
 142                     ; 63 void WWDG_SetCounter(uint8_t Counter)
 142                     ; 64 {
 143                     	switch	.text
 144  002f               _WWDG_SetCounter:
 146  002f 88            	push	a
 147       00000000      OFST:	set	0
 150                     ; 67     assert_param(IS_WWDG_COUNTERVALUE_OK(Counter));
 152  0030 a180          	cp	a,#128
 153  0032 2403          	jruge	L41
 154  0034 4f            	clr	a
 155  0035 2010          	jra	L61
 156  0037               L41:
 157  0037 ae0043        	ldw	x,#67
 158  003a 89            	pushw	x
 ...
 303  0071               L03:
 304                     ; 109     WWDG->WR = (uint8_t)((uint8_t)(~WWDG_CR_WDGA) & (uint8_t)(WWDG_CR_T6 | WindowValue));
 ...
 334  0000               L33:
 335  0000 7374645f6c69  	dc.b	"std_lib\src\stm8s_"
 336  0012 777764672e63  	dc.b	"wwdg.c",0
 356                     	end
